...
/**
 * This class provides an empty implementation of {@link MonsterSpellGrammarListener},
 * which can be extended to create a listener which only needs to handle a subset
 * of the available methods.
 */
@SuppressWarnings("CheckReturnValue")
public class MonsterSpellGrammarBaseListener implements MonsterSpellGrammarListener {
    /**
     * {@inheritDoc}
     *
     ...
     */
    @Override
    public void exitRecordCount(MonsterSpellGrammar.RecordCountContext ctx) {
    }
	/**
	 * {@inheritDoc}
	 *
     ...
     */
    @Override
    public void exitEffectBlock(MonsterSpellGrammar.EffectBlockContext ctx) { }
