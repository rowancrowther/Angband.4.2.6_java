 ...
 * {@link uk.co.jackoftradesltd.channel.uichannel.UIReceiver} receives at this width, because only the
 * UI thread's inbox carries both senders; the core's inbox is typed to {@link UIMessage} alone.
 *
 * @see uk.co.jackoftradesltd.channel.Channels the queues these travel on
 */
