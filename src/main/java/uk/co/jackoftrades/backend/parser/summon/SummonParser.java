...
public class SummonParser extends Parser {
    ...
    public static class NameContext extends ParserRuleContext {
        ...
        public TerminalNode NAME() {
            return getToken(SummonParser.NAME, 0);
        }

        public TerminalNode FLAG() {
            return getToken(SummonParser.FLAG, 0);
        }
    ...
    public static class MsgtContext extends ParserRuleContext {
        ...
        public TerminalNode MSGT() {
            return getToken(SummonParser.MSGT, 0);
        }
    ...
    public static class UniquesContext extends ParserRuleContext {
        ...
        public TerminalNode UNIQUES() {
            return getToken(SummonParser.UNIQUES, 0);
        }

        public TerminalNode BOOLEAN() {
            return getToken(SummonParser.BOOLEAN, 0);
        }
    ...
    public static class BaseContext extends ParserRuleContext {
        ...
        public TerminalNode BASE() {
            return getToken(SummonParser.BASE, 0);
        }

        public TerminalNode TEXT() {
            return getToken(SummonParser.TEXT, 0);
        }
    ...
    public static class Race_flagContext extends ParserRuleContext {
        ...
        public TerminalNode RACE_FLAG() {
            return getToken(SummonParser.RACE_FLAG, 0);
        }
    ...
    public static class FallbackContext extends ParserRuleContext {
        ...
        public TerminalNode FALLBACK() {
            return getToken(SummonParser.FALLBACK, 0);
        }
    ...
    public static class DescContext extends ParserRuleContext {
        ...
        public TerminalNode DESC() {
            return getToken(SummonParser.DESC, 0);
        }
    ...
    public static class FileContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(SummonParser.EOF, 0);
        }
