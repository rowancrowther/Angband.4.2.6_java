...
import uk.co.jackoftradesltd.backend.parser.grammars.playerrace.PlayerRaceGrammar;
import uk.co.jackoftradesltd.backend.parser.grammars.playerrace.PlayerRaceLexer;
import uk.co.jackoftradesltd.backend.parser.playerrace.PlayerRaceAssembler;
...
public class PlayerRaceReader implements Reader<PlayerRace> {
    ...
    /**
     * Parses {@code filename} and returns just the assembled player races, discarding the
     ...
     * @return the player races read from the file
     ...
     * @return a defensive copy of the parsed player-race records for the assembler
     */
     ...
     * {@link PlayerRace}s together with any soft errors collected during parsing and assembly.
     ...
     *
     * @param filename the player-race data file to read
     * @return the parse result: the player races plus any error messages
     * @throws IOException if the file cannot be read
     */
