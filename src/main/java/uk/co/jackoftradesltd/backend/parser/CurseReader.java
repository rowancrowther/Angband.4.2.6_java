...
import uk.co.jackoftradesltd.backend.parser.grammars.curse.CurseGrammar;
import uk.co.jackoftradesltd.backend.parser.grammars.curse.CurseLexer;
...
/**
 * Loads the relevant data-file entries into {@link Curse} objects by driving the
...
public class CurseReader implements Reader<Curse> {
    ...
    /**
     * Parses {@code filename} and returns just the assembled curses, discarding the
     ...
     * @return the curses read from the file
     ...
     * @return a defensive copy of the parsed curse records for the assembler
     */
     ...
     * {@link Curse}s together with any soft errors collected during parsing and assembly.
     ...
     *
     * @param filename the curse data file to read
     * @return the parse result: the curses plus any error messages
     * @throws IOException if the file cannot be read
     */
