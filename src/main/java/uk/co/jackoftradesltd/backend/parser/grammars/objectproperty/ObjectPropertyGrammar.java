...
package uk.co.jackoftradesltd.backend.parser.grammars.objectproperty;
...
public class ObjectPropertyGrammar extends Parser {
    ...
    public String getGrammarFileName() {
        return "ObjectPropertyGrammar.g4";
    }
    ...
    public static class RecordCountContext extends ParserRuleContext {
        ...
        public TerminalNode RECORD_COUNT() {
            return getToken(ObjectPropertyGrammar.RECORD_COUNT, 0);
        }

        public TerminalNode INTEGER() {
            return getToken(ObjectPropertyGrammar.INTEGER, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).enterRecordCount(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).exitRecordCount(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ObjectPropertyGrammarVisitor)
                return ((ObjectPropertyGrammarVisitor<? extends T>) visitor).visitRecordCount(this);
    ...
    public static class NameContext extends ParserRuleContext {
        ...
        public TerminalNode NAME() {
            return getToken(ObjectPropertyGrammar.NAME, 0);
        }

        public TerminalNode STRING() {
            return getToken(ObjectPropertyGrammar.STRING, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).enterName(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).exitName(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ObjectPropertyGrammarVisitor)
                return ((ObjectPropertyGrammarVisitor<? extends T>) visitor).visitName(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public final NameContext name() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                ((NameContext) _localctx).nameString = ((NameContext) _localctx).STRING.getText();
    ...
    public static class TypeContext extends ParserRuleContext {
        ...
        public TerminalNode TYPE() {
            return getToken(ObjectPropertyGrammar.TYPE, 0);
        }

        public TerminalNode LCASE() {
            return getToken(ObjectPropertyGrammar.LCASE, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).enterType(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).exitType(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ObjectPropertyGrammarVisitor)
                return ((ObjectPropertyGrammarVisitor<? extends T>) visitor).visitType(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class SubtypeContext extends ParserRuleContext {
        ...
        public TerminalNode SUBTYPE() {
            return getToken(ObjectPropertyGrammar.SUBTYPE, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).enterSubtype(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).exitSubtype(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ObjectPropertyGrammarVisitor)
                return ((ObjectPropertyGrammarVisitor<? extends T>) visitor).visitSubtype(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class IdTypeContext extends ParserRuleContext {
        ...
        public TerminalNode ID_TYPE() {
            return getToken(ObjectPropertyGrammar.ID_TYPE, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).enterIdType(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).exitIdType(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ObjectPropertyGrammarVisitor)
                return ((ObjectPropertyGrammarVisitor<? extends T>) visitor).visitIdType(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class CodeValContext extends ParserRuleContext {
        ...
        public TerminalNode CODE() {
            return getToken(ObjectPropertyGrammar.CODE, 0);
        }

        public TerminalNode UCASE() {
            return getToken(ObjectPropertyGrammar.UCASE, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).enterCodeVal(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).exitCodeVal(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ObjectPropertyGrammarVisitor)
                return ((ObjectPropertyGrammarVisitor<? extends T>) visitor).visitCodeVal(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class PowerContext extends ParserRuleContext {
        ...
        public TerminalNode POWER() {
            return getToken(ObjectPropertyGrammar.POWER, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).enterPower(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).exitPower(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ObjectPropertyGrammarVisitor)
                return ((ObjectPropertyGrammarVisitor<? extends T>) visitor).visitPower(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class MultContext extends ParserRuleContext {
        ...
        public TerminalNode MULT() {
            return getToken(ObjectPropertyGrammar.MULT, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).enterMult(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).exitMult(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ObjectPropertyGrammarVisitor)
                return ((ObjectPropertyGrammarVisitor<? extends T>) visitor).visitMult(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class TypeMultContext extends ParserRuleContext {
        ...
        public TerminalNode TYPE_MULT() {
            return getToken(ObjectPropertyGrammar.TYPE_MULT, 0);
        }

        public TerminalNode DELIM_COLON() {
            return getToken(ObjectPropertyGrammar.DELIM_COLON, 0);
        }

        public TerminalNode STRING_BETWEEN_COLONS() {
            return getToken(ObjectPropertyGrammar.STRING_BETWEEN_COLONS, 0);
        }

        public TerminalNode DELIM_INTEGER() {
            return getToken(ObjectPropertyGrammar.DELIM_INTEGER, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).enterTypeMult(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).exitTypeMult(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ObjectPropertyGrammarVisitor)
                return ((ObjectPropertyGrammarVisitor<? extends T>) visitor).visitTypeMult(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class AdjectiveContext extends ParserRuleContext {
        ...
        public TerminalNode ADJECTIVE() {
            return getToken(ObjectPropertyGrammar.ADJECTIVE, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).enterAdjective(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).exitAdjective(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ObjectPropertyGrammarVisitor)
                return ((ObjectPropertyGrammarVisitor<? extends T>) visitor).visitAdjective(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class NegAdjectiveContext extends ParserRuleContext {
        ...
        public TerminalNode NEG_ADJECTIVE() {
            return getToken(ObjectPropertyGrammar.NEG_ADJECTIVE, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).enterNegAdjective(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).exitNegAdjective(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ObjectPropertyGrammarVisitor)
                return ((ObjectPropertyGrammarVisitor<? extends T>) visitor).visitNegAdjective(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class MsgContext extends ParserRuleContext {
        ...
        public TerminalNode MSG() {
            return getToken(ObjectPropertyGrammar.MSG, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).enterMsg(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).exitMsg(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ObjectPropertyGrammarVisitor)
                return ((ObjectPropertyGrammarVisitor<? extends T>) visitor).visitMsg(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class BinduiContext extends ParserRuleContext {
        ...
        public TerminalNode BINDUI() {
            return getToken(ObjectPropertyGrammar.BINDUI, 0);
        }

        public List<TerminalNode> COLON() {
            return getTokens(ObjectPropertyGrammar.COLON);
        }
        ...
        public List<TerminalNode> INTEGER() {
            return getTokens(ObjectPropertyGrammar.INTEGER);
        }
        ...
        public TerminalNode LTHAN() {
            return getToken(ObjectPropertyGrammar.LTHAN, 0);
        }

        public TerminalNode GTHAN() {
            return getToken(ObjectPropertyGrammar.GTHAN, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).enterBindui(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).exitBindui(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ObjectPropertyGrammarVisitor)
                return ((ObjectPropertyGrammarVisitor<? extends T>) visitor).visitBindui(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class DescContext extends ParserRuleContext {
        ...
        public TerminalNode DESC() {
            return getToken(ObjectPropertyGrammar.DESC, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).enterDesc(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).exitDesc(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ObjectPropertyGrammarVisitor)
                return ((ObjectPropertyGrammarVisitor<? extends T>) visitor).visitDesc(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ObjectPropertyContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).enterObjectProperty(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).exitObjectProperty(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ObjectPropertyGrammarVisitor)
                return ((ObjectPropertyGrammarVisitor<? extends T>) visitor).visitObjectProperty(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public final ObjectPropertyContext objectProperty() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                line = ((ObjectPropertyContext) _localctx).name.lineNo;
                nameInit = ((ObjectPropertyContext) _localctx).name.nameString;
                setState(105);
    ...
    public static class FileContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(ObjectPropertyGrammar.EOF, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).enterFile(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ObjectPropertyGrammarListener)
                ((ObjectPropertyGrammarListener) listener).exitFile(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ObjectPropertyGrammarVisitor)
                return ((ObjectPropertyGrammarVisitor<? extends T>) visitor).visitFile(this);
            else return visitor.visitChildren(this);
        }
    }
