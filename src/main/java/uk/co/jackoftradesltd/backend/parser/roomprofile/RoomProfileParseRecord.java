...
package uk.co.jackoftradesltd.backend.parser.roomprofile;

import java.util.List;

/**
 * One raw room record straight out of {@link uk.co.jackoftradesltd.backend.parser.grammars.roomprofiler.RoomProfileGrammar}
