 ...
 * trick {@link uk.co.jackoftrades.channel.corechannel.CoreSender} uses, and it is what
 ...
 * across.
 *
 * @see uk.co.jackoftrades.channel.uichannel.UIReceiver the end that reads what this writes
 */
