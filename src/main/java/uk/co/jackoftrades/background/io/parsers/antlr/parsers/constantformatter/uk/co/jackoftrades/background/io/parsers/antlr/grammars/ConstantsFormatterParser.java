...
package uk.co.jackoftrades.background.io.parsers.antlr.parsers.constantformatter.uk.co.jackoftrades.background.io.parsers.antlr.grammars;
...
public class ConstantsFormatterParser extends Parser {
    ...
    public final SectionContext section() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                _localctx.value = ((SectionContext) _localctx).token2.getText()
                setState(15);
                match(COLON);
                setState(16);
    ...
    public final FurtherValueContext furtherValue() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                ((FurtherValueContext) _localctx).further = ((FurtherValueContext) _localctx).val1.getText() + ":" + val2.getText() + ":" + ((FurtherValueContext) _localctx).FURTHER.getText();
    ...
    public final MultiValueContext multiValue() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                setState(29);
                match(TOKEN);
                ((MultiValueContext) _localctx).sect = TOKEN.getText();
                setState(31);
                match(COLON);
                setState(32);
                ...
                _localctx.multi = ((MultiValueContext) _localctx).val1.getText() + ":" + ((MultiValueContext) _localctx).val2.getText() + ":" + ((MultiValueContext) _localctx).val3.getText() + ":" + ((MultiValueContext) _localctx).FURTHER.getText():
    ...
    public final FileContext file() throws RecognitionException {
        ...
        ((FileContext) _localctx).constants = new ArrayList<String>();
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                constant.setSection(((FileContext) _localctx).l1.sect);
                constant.setValue(((FileContext) _localctx).l1.val);
                _localctx.constants.add(constant);
                    ...
                    {
                        {
                            ...
                            Constant constant = new Constant();
                            constant.setSection(((FileContext) _localctx).l2.sect);
                            constant.setValue(((FileContext) _localctx).l2.val);
                            _localctx.constants.add(constant);
