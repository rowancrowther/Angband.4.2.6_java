...
package uk.co.jackoftradesltd.backend.parser.grammars.artifact;
...
public class ArtifactGrammar extends Parser {
    ...
    public static class RecordCountContext extends ParserRuleContext {
        ...
        public TerminalNode RECORD_COUNT() {
            return getToken(ArtifactGrammar.RECORD_COUNT, 0);
        }

        public TerminalNode ARTIFACT_INTEGER() {
            return getToken(ArtifactGrammar.ARTIFACT_INTEGER, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ArtifactGrammarListener)
                ((ArtifactGrammarListener) listener).enterRecordCount(this);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ArtifactGrammarVisitor)
                return ((ArtifactGrammarVisitor<? extends T>) visitor).visitRecordCount(this);
    ...
    public static class NameContext extends ParserRuleContext {
        ...
        public TerminalNode NAME() {
            return getToken(ArtifactGrammar.NAME, 0);
        }

        public TerminalNode STRING() {
            return getToken(ArtifactGrammar.STRING, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ArtifactGrammarVisitor)
                return ((ArtifactGrammarVisitor<? extends T>) visitor).visitName(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class BaseObjectContext extends ParserRuleContext {
        ...
        public TerminalNode BASE_OBJECT() {
            return getToken(ArtifactGrammar.BASE_OBJECT, 0);
        }

        public TerminalNode DELIM_COLON() {
            return getToken(ArtifactGrammar.DELIM_COLON, 0);
        }

        public List<TerminalNode> STRING_BETWEEN_COLONS() {
            return getTokens(ArtifactGrammar.STRING_BETWEEN_COLONS);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ArtifactGrammarVisitor)
                return ((ArtifactGrammarVisitor<? extends T>) visitor).visitBaseObject(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public final BaseObjectContext baseObject() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                ((BaseObjectContext) _localctx).tVal = ((BaseObjectContext) _localctx).t.getText();
                ((BaseObjectContext) _localctx).sVal = ((BaseObjectContext) _localctx).s.getText();
            }
        } catch (RecognitionException re) {
            _localctx.exception = re;
            _errHandler.reportError(this, re);
    ...
    public static class GraphicsContext extends ParserRuleContext {
        ...
        public TerminalNode GRAPHICS() {
            return getToken(ArtifactGrammar.GRAPHICS, 0);
        }

        public TerminalNode GLYPH_COLON_SWITCH() {
            return getToken(ArtifactGrammar.GLYPH_COLON_SWITCH, 0);
        }

        public TerminalNode GLYPH_VALUES() {
            return getToken(ArtifactGrammar.GLYPH_VALUES, 0);
        }

        public TerminalNode COLOUR_VALUES() {
            return getToken(ArtifactGrammar.COLOUR_VALUES, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ArtifactGrammarVisitor)
                return ((ArtifactGrammarVisitor<? extends T>) visitor).visitGraphics(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class LevelContext extends ParserRuleContext {
        ...
        public TerminalNode LEVEL() {
            return getToken(ArtifactGrammar.LEVEL, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ArtifactGrammarVisitor)
                return ((ArtifactGrammarVisitor<? extends T>) visitor).visitLevel(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class WeightContext extends ParserRuleContext {
        ...
        public TerminalNode WEIGHT() {
            return getToken(ArtifactGrammar.WEIGHT, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ArtifactGrammarVisitor)
                return ((ArtifactGrammarVisitor<? extends T>) visitor).visitWeight(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class CostContext extends ParserRuleContext {
        ...
        public TerminalNode COST() {
            return getToken(ArtifactGrammar.COST, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ArtifactGrammarVisitor)
                return ((ArtifactGrammarVisitor<? extends T>) visitor).visitCost(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class AllocContext extends ParserRuleContext {
        ...
        public TerminalNode ALLOC() {
            return getToken(ArtifactGrammar.ALLOC, 0);
        }

        public TerminalNode ALLOC_COLON() {
            return getToken(ArtifactGrammar.ALLOC_COLON, 0);
        }

        public TerminalNode ALLOC_TO() {
            return getToken(ArtifactGrammar.ALLOC_TO, 0);
        }

        public List<TerminalNode> ALLOC_INT() {
            return getTokens(ArtifactGrammar.ALLOC_INT);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ArtifactGrammarVisitor)
                return ((ArtifactGrammarVisitor<? extends T>) visitor).visitAlloc(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public final AllocContext alloc() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                ((AllocContext) _localctx).commonness = ((AllocContext) _localctx).c.getText();
                ((AllocContext) _localctx).min = ((AllocContext) _localctx).mn.getText();
                ((AllocContext) _localctx).max = ((AllocContext) _localctx).mx.getText();
            }
        } catch (RecognitionException re) {
            _localctx.exception = re;
            _errHandler.reportError(this, re);
    ...
    public static class AttackContext extends ParserRuleContext {
        ...
        public TerminalNode ATTACK() {
            return getToken(ArtifactGrammar.ATTACK, 0);
        }

        public List<TerminalNode> ARTIFACT_COLON() {
            return getTokens(ArtifactGrammar.ARTIFACT_COLON);
        }
        ...
        public List<TerminalNode> ARTIFACT_INTEGER() {
            return getTokens(ArtifactGrammar.ARTIFACT_INTEGER);
        }
        ...
        public TerminalNode SIMPLE_DICE_STRING() {
            return getToken(ArtifactGrammar.SIMPLE_DICE_STRING, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ArtifactGrammarVisitor)
                return ((ArtifactGrammarVisitor<? extends T>) visitor).visitAttack(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ArmourContext extends ParserRuleContext {
        ...
        public TerminalNode ARMOUR() {
            return getToken(ArtifactGrammar.ARMOUR, 0);
        }

        public TerminalNode ARTIFACT_COLON() {
            return getToken(ArtifactGrammar.ARTIFACT_COLON, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ArtifactGrammarVisitor)
                return ((ArtifactGrammarVisitor<? extends T>) visitor).visitArmour(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class FlagsContext extends ParserRuleContext {
        ...
        public TerminalNode FLAGS() {
            return getToken(ArtifactGrammar.FLAGS, 0);
        }

        public List<TerminalNode> FLAG() {
            return getTokens(ArtifactGrammar.FLAG);
        }
        ...
        public List<TerminalNode> FLAG_OR() {
            return getTokens(ArtifactGrammar.FLAG_OR);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ArtifactGrammarVisitor)
                return ((ArtifactGrammarVisitor<? extends T>) visitor).visitFlags(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ActContext extends ParserRuleContext {
        ...
        public TerminalNode ACT() {
            return getToken(ArtifactGrammar.ACT, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ArtifactGrammarVisitor)
                return ((ArtifactGrammarVisitor<? extends T>) visitor).visitAct(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class TimeContext extends ParserRuleContext {
        ...
        public TerminalNode TIME() {
            return getToken(ArtifactGrammar.TIME, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ArtifactGrammarVisitor)
                return ((ArtifactGrammarVisitor<? extends T>) visitor).visitTime(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class MsgContext extends ParserRuleContext {
        ...
        public TerminalNode MSG() {
            return getToken(ArtifactGrammar.MSG, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ArtifactGrammarVisitor)
                return ((ArtifactGrammarVisitor<? extends T>) visitor).visitMsg(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ValuesContext extends ParserRuleContext {
        ...
        public TerminalNode VALUES() {
            return getToken(ArtifactGrammar.VALUES, 0);
        }

        public List<TerminalNode> VALUES_LBRACKET() {
            return getTokens(ArtifactGrammar.VALUES_LBRACKET);
        }
        ...
        public List<TerminalNode> VALUES_RBRACKET() {
            return getTokens(ArtifactGrammar.VALUES_RBRACKET);
        }
        ...
        public List<TerminalNode> VALUES_STRING() {
            return getTokens(ArtifactGrammar.VALUES_STRING);
        }
        ...
        public List<TerminalNode> VALUES_INTEGER() {
            return getTokens(ArtifactGrammar.VALUES_INTEGER);
        }
        ...
        public List<TerminalNode> VALUES_OR() {
            return getTokens(ArtifactGrammar.VALUES_OR);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ArtifactGrammarVisitor)
                return ((ArtifactGrammarVisitor<? extends T>) visitor).visitValues(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class BrandContext extends ParserRuleContext {
        ...
        public TerminalNode BRAND() {
            return getToken(ArtifactGrammar.BRAND, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ArtifactGrammarVisitor)
                return ((ArtifactGrammarVisitor<? extends T>) visitor).visitBrand(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class SlayContext extends ParserRuleContext {
        ...
        public TerminalNode SLAY() {
            return getToken(ArtifactGrammar.SLAY, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ArtifactGrammarVisitor)
                return ((ArtifactGrammarVisitor<? extends T>) visitor).visitSlay(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class CurseContext extends ParserRuleContext {
        ...
        public TerminalNode CURSE() {
            return getToken(ArtifactGrammar.CURSE, 0);
        }
        ...
        public TerminalNode STRING_BETWEEN_COLONS() {
            return getToken(ArtifactGrammar.STRING_BETWEEN_COLONS, 0);
        }

        public TerminalNode DELIM_INTEGER() {
            return getToken(ArtifactGrammar.DELIM_INTEGER, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ArtifactGrammarVisitor)
                return ((ArtifactGrammarVisitor<? extends T>) visitor).visitCurse(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public final CurseContext curse() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                match(DELIM_COLON);
                setState(153);
                ((CurseContext) _localctx).v = match(DELIM_INTEGER);
    ...
    public static class DescContext extends ParserRuleContext {
        ...
        public TerminalNode DESC() {
            return getToken(ArtifactGrammar.DESC, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ArtifactGrammarVisitor)
                return ((ArtifactGrammarVisitor<? extends T>) visitor).visitDesc(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ArtifactContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ArtifactGrammarVisitor)
                return ((ArtifactGrammarVisitor<? extends T>) visitor).visitArtifact(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public final ArtifactContext artifact() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                line = ((ArtifactContext) _localctx).name.line;
                ...
                do {
                    {
                        ...
                        switch (_input.LA(1)) {
                            case BASE_OBJECT: {
                                ...
                                tValueInit = ((ArtifactContext) _localctx).baseObject.tVal;
                                sValueInit = ((ArtifactContext) _localctx).baseObject.sVal;
                            }
                            break;
                            case GRAPHICS: {
                                setState(165);
                                ((ArtifactContext) _localctx).graphics = graphics();
                                glyphInit = ((ArtifactContext) _localctx).graphics.glyph;
                                colourInit = ((ArtifactContext) _localctx).graphics.colour;
                            }
                            break;
                            case LEVEL: {
                                setState(168);
                            ...
                            case FLAGS: {
                                ...
                                flagListInit.addAll(((ArtifactContext) _localctx).flags.flagList);
                            }
                            break;
                            case ACT: {
                                setState(189);
    ...
    public static class FileContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(ArtifactGrammar.EOF, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ArtifactGrammarVisitor)
                return ((ArtifactGrammarVisitor<? extends T>) visitor).visitFile(this);
            else return visitor.visitChildren(this);
        }
    }
