 ...
 * {@link uk.co.jackoftradesltd.middle.player.Player} needs — a body, a race, a curse list and a
...
public class SeededPlayerRegistry implements BeforeAllCallback, AfterAllCallback {
     ...
     * is needed not by {@code Player} itself but by {@link uk.co.jackoftradesltd.middle.objects.KnownObject},
     ...
     *
     * <p>{@code Player}'s constructor builds a {@link uk.co.jackoftradesltd.middle.player.PlayerUpkeep},
