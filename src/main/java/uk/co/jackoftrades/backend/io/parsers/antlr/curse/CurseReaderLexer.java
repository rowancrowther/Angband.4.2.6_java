...
public class CurseReaderLexer extends Lexer {
    static {
    ...
    private static String[] makeRuleNames() {
        return new String[]{
                "COMMENT", "EOL", "NAME", "TYPE", "WEIGHT", "COMBAT", "EFFECT", "DICE",
                "EXPR", "TIME", "FLAGS", "VALUES", "MSG", "DESC", "CONFLICT", "CONFLICT_FLAGS",
                "VALUE", "TEXT", "COLON", "OR"
        };
    }
    ...
    public CurseReaderLexer(CharStream input) {
        super(input);
