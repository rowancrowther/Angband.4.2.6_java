...
public class MonsterParser extends Parser {
    ...
    public static class NameContext extends ParserRuleContext {
        ...
        public TerminalNode NAME() {
            return getToken(MonsterParser.NAME, 0);
        }

        public TerminalNode LCASE() {
            return getToken(MonsterParser.LCASE, 0);
        }
    ...
    public static class PluralContext extends ParserRuleContext {
        ...
        public TerminalNode PLURAL() {
            return getToken(MonsterParser.PLURAL, 0);
        }
    ...
    public static class BaseContext extends ParserRuleContext {
        ...
        public TerminalNode BASE() {
            return getToken(MonsterParser.BASE, 0);
        }
    ...
    public final BaseContext base() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                ((BaseContext) _localctx).baseObj = GameConstants.getMonsterBase(raw);
    ...
    public static class GlyphContext extends ParserRuleContext {
        ...
        public TerminalNode GLYPH() {
            return getToken(MonsterParser.GLYPH, 0);
        }
    ...
    public static class ColourContext extends ParserRuleContext {
        ...
        public TerminalNode COLOUR() {
            return getToken(MonsterParser.COLOUR, 0);
        }

        public TerminalNode COLOUR_CHAR() {
            return getToken(MonsterParser.COLOUR_CHAR, 0);
        }
    ...
    public static class ColourCycleContext extends ParserRuleContext {
        ...
        public TerminalNode COLOUR_CYCLE() {
            return getToken(MonsterParser.COLOUR_CYCLE, 0);
        }

        public TerminalNode COLON() {
            return getToken(MonsterParser.COLON, 0);
        }

        public List<TerminalNode> LCASE() {
            return getTokens(MonsterParser.LCASE);
        }
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof MonsterVisitor)
                return ((MonsterVisitor<? extends T>) visitor).visitColourCycle(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class SpeedContext extends ParserRuleContext {
        ...
        public TerminalNode SPEED() {
            return getToken(MonsterParser.SPEED, 0);
        }

        public TerminalNode INTEGER() {
            return getToken(MonsterParser.INTEGER, 0);
        }
    ...
    public static class HitPointsContext extends ParserRuleContext {
        ...
        public TerminalNode HIT_POINTS() {
            return getToken(MonsterParser.HIT_POINTS, 0);
        }
    ...
    public static class LightContext extends ParserRuleContext {
        ...
        public TerminalNode LIGHT() {
            return getToken(MonsterParser.LIGHT, 0);
        }
    ...
    public static class HearingContext extends ParserRuleContext {
        ...
        public TerminalNode HEARING() {
            return getToken(MonsterParser.HEARING, 0);
        }
    ...
    public static class SmellContext extends ParserRuleContext {
        ...
        public TerminalNode SMELL() {
            return getToken(MonsterParser.SMELL, 0);
        }
    ...
    public static class ArmourClassContext extends ParserRuleContext {
        ...
        public TerminalNode ARMOUR_CLASS() {
            return getToken(MonsterParser.ARMOUR_CLASS, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof MonsterVisitor)
                return ((MonsterVisitor<? extends T>) visitor).visitArmourClass(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class SleepinessContext extends ParserRuleContext {
        ...
        public TerminalNode SLEEPINESS() {
            return getToken(MonsterParser.SLEEPINESS, 0);
        }
    ...
    public static class DungeonDepthContext extends ParserRuleContext {
        ...
        public TerminalNode DEPTH() {
            return getToken(MonsterParser.DEPTH, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof MonsterVisitor)
                return ((MonsterVisitor<? extends T>) visitor).visitDungeonDepth(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class RarityContext extends ParserRuleContext {
        ...
        public TerminalNode RARITY() {
            return getToken(MonsterParser.RARITY, 0);
        }
    ...
    public static class ExperienceContext extends ParserRuleContext {
        ...
        public TerminalNode EXPERIENCE() {
            return getToken(MonsterParser.EXPERIENCE, 0);
        }
    ...
    public static class BlowContext extends ParserRuleContext {
        ...
        public TerminalNode BLOW() {
            return getToken(MonsterParser.BLOW, 0);
        }

        public List<TerminalNode> COLON() {
            return getTokens(MonsterParser.COLON);
        }
        ...
        public List<TerminalNode> UCASE() {
            return getTokens(MonsterParser.UCASE);
        }
        ...
        public TerminalNode DICE_STRING() {
            return getToken(MonsterParser.DICE_STRING, 0);
        }
    ...
    public static class FlagsContext extends ParserRuleContext {
        ...
        public TerminalNode FLAGS() {
            return getToken(MonsterParser.FLAGS, 0);
        }
    ...
    public static class FlagsOffContext extends ParserRuleContext {
        ...
        public TerminalNode FLAGS_OFF() {
            return getToken(MonsterParser.FLAGS_OFF, 0);
        }
        ...
        public List<TerminalNode> OR() {
            return getTokens(MonsterParser.OR);
        }
    ...
    public static class InnateFreqContext extends ParserRuleContext {
        ...
        public TerminalNode INNATE_FREQ() {
            return getToken(MonsterParser.INNATE_FREQ, 0);
        }
    ...
    public static class SpellFreqContext extends ParserRuleContext {
        ...
        public TerminalNode SPELL_FREQ() {
            return getToken(MonsterParser.SPELL_FREQ, 0);
        }
    ...
    public static class SpellPowerContext extends ParserRuleContext {
        ...
        public TerminalNode SPELL_POWER() {
            return getToken(MonsterParser.SPELL_POWER, 0);
        }
    ...
    public static class SpellsContext extends ParserRuleContext {
        ...
        public TerminalNode SPELLS() {
            return getToken(MonsterParser.SPELLS, 0);
        }
    ...
    public static class MessageVisContext extends ParserRuleContext {
        ...
        public TerminalNode MESSAGE_VIS() {
            return getToken(MonsterParser.MESSAGE_VIS, 0);
        }

        public TerminalNode UCASE() {
            return getToken(MonsterParser.UCASE, 0);
        }
    ...
    public static class MessageInvisContext extends ParserRuleContext {
        ...
        public TerminalNode MESSAGE_INVIS() {
            return getToken(MonsterParser.MESSAGE_INVIS, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof MonsterVisitor)
                return ((MonsterVisitor<? extends T>) visitor).visitMessageInvis(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class MessageMissContext extends ParserRuleContext {
        ...
        public TerminalNode MESSAGE_MISS() {
            return getToken(MonsterParser.MESSAGE_MISS, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof MonsterVisitor)
                return ((MonsterVisitor<? extends T>) visitor).visitMessageMiss(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class DescContext extends ParserRuleContext {
        ...
        public TerminalNode DESC() {
            return getToken(MonsterParser.DESC, 0);
        }
    ...
    public static class ShapeContext extends ParserRuleContext {
        ...
        public TerminalNode SHAPE() {
            return getToken(MonsterParser.SHAPE, 0);
        }
    ...
    public static class DropContext extends ParserRuleContext {
        ...
        public TerminalNode DROP() {
            return getToken(MonsterParser.DROP, 0);
        }
        ...
        public List<TerminalNode> INTEGER() {
            return getTokens(MonsterParser.INTEGER);
        }
    ...
    public static class DropBaseContext extends ParserRuleContext {
        ...
        public TerminalNode DROP_BASE() {
            return getToken(MonsterParser.DROP_BASE, 0);
        }
    ...
    public static class MimicContext extends ParserRuleContext {
        ...
        public TerminalNode MIMIC() {
            return getToken(MonsterParser.MIMIC, 0);
        }
    ...
    public static class FriendsContext extends ParserRuleContext {
        ...
        public TerminalNode FRIENDS() {
            return getToken(MonsterParser.FRIENDS, 0);
        }
    ...
    public static class FriendsBaseContext extends ParserRuleContext {
        ...
        public TerminalNode FRIENDS_BASE() {
            return getToken(MonsterParser.FRIENDS_BASE, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof MonsterVisitor)
                return ((MonsterVisitor<? extends T>) visitor).visitFriendsBase(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class FileContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(MonsterParser.EOF, 0);
        }
