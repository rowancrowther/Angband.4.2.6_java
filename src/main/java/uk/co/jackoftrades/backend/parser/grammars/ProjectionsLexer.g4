...
import CommentsAndEol, DiceStrings;

/*
 * @author Rowan Crowther
 *
 * record-count directive
 * cf Projections.g4's 'recordCount' rule
 */
RECORD_COUNT
        :   'record-count:'
        ;
 ...
 * cf Projections.g4's 'playerDesc' rule
 */
PLAYER_DESC
 ...
 * cf Projections.g4's 'blindDesc' rule
 */
BLIND_DESC
 ...
 *
 * lash-desc directive
 * cf Projections.g4's 'lashDesc' rule
 */
LASH_DESC
 ...
 *
 * numerator directive
 * cf Projections.g4's 'numerator' rule
 */
NUMERATOR
        :   'numerator:'
        ;
 ...
 * cf Projections.g4's 'denominator' rule
 */
DENOMINATOR
 ...
 *
 * divisor directive
 * cf Projections.g4's 'divisor' rule
 */
DIVISOR :   'divisor:'
        ;
 ...
 * cf Projections.g4's 'damageCap' rule
 */
DAMAGE_CAP
        :   'damage-cap:'
        ;
 ...
 *
 * obvious directive
 * cf Projections.g4's 'obvious' rule
 */
OBVIOUS :   'obvious:'
        ;
 ...
 *
 * colour directive
 * cf Projections.g4's 'colour' rule
 */
 ...
 * @author Rowan Crowther
 *
 * An UPPER_CASE_WITH_UNDERSCORES symbolic name
 * cf Projections.g4's 'msgt' and 'code' rules
 */
TAG     :   ('A'..'Z'|'_')+
        ;
 ...
 * cf Projections.g4's 'recordCount', 'numerator', 'divisor',
 ...
 * cf Projections.g4's 'name', 'type', 'desc', 'playerDesc', 'blindDesc',
