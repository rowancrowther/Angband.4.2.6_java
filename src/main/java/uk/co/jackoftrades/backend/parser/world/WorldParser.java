...
public class WorldParser extends Parser {
    static {
    ...
    public WorldParser(TokenStream input) {
        super(input);
    ...
    public static class LevelNumContext extends ParserRuleContext {
        ...
        public TerminalNode NUMBER() {
            return getToken(WorldParser.NUMBER, 0);
        }

        public TerminalNode COLON() {
            return getToken(WorldParser.COLON, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof WorldListener) ((WorldListener) listener).enterLevelNum(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof WorldListener) ((WorldListener) listener).exitLevelNum(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof WorldVisitor) return ((WorldVisitor<? extends T>) visitor).visitLevelNum(this);
    ...
    public static class LevelNameContext extends ParserRuleContext {
        ...
        public TerminalNode NAME() {
            return getToken(WorldParser.NAME, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof WorldListener) ((WorldListener) listener).enterLevelName(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof WorldListener) ((WorldListener) listener).exitLevelName(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof WorldVisitor) return ((WorldVisitor<? extends T>) visitor).visitLevelName(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class UpAndDownContext extends ParserRuleContext {
        ...
        public List<TerminalNode> NAME() {
            return getTokens(WorldParser.NAME);
        }

        public TerminalNode NAME(int i) {
            return getToken(WorldParser.NAME, i);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof WorldListener) ((WorldListener) listener).enterUpAndDown(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof WorldListener) ((WorldListener) listener).exitUpAndDown(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof WorldVisitor) return ((WorldVisitor<? extends T>) visitor).visitUpAndDown(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class LineContext extends ParserRuleContext {
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof WorldListener) ((WorldListener) listener).enterLine(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof WorldListener) ((WorldListener) listener).exitLine(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof WorldVisitor) return ((WorldVisitor<? extends T>) visitor).visitLine(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public final LineContext line() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                ((LineContext) _localctx).world = new ParsedWorld(((LineContext) _localctx).levelNum.num, ((LineContext) _localctx).levelName.name, ((LineContext) _localctx).upAndDown.previous, ((LineContext) _localctx).upAndDown.next);
    ...
    public static class FileContext extends ParserRuleContext {
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof WorldListener) ((WorldListener) listener).enterFile(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof WorldListener) ((WorldListener) listener).exitFile(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof WorldVisitor) return ((WorldVisitor<? extends T>) visitor).visitFile(this);
            else return visitor.visitChildren(this);
        }
    }
