...
public class BlowEffectParser extends Parser {
    ...
    public static class NameContext extends ParserRuleContext {
        ...
        public TerminalNode NAME() {
            return getToken(BlowEffectParser.NAME, 0);
        }

        public TerminalNode UCASE() {
            return getToken(BlowEffectParser.UCASE, 0);
        }
    ...
    public static class PowerContext extends ParserRuleContext {
        ...
        public TerminalNode POWER() {
            return getToken(BlowEffectParser.POWER, 0);
        }

        public TerminalNode INTEGER() {
            return getToken(BlowEffectParser.INTEGER, 0);
        }
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof BlowEffectVisitor)
                return ((BlowEffectVisitor<? extends T>) visitor).visitPower(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class EvalContext extends ParserRuleContext {
        ...
        public TerminalNode EVAL() {
            return getToken(BlowEffectParser.EVAL, 0);
        }
    ...
    public static class DescContext extends ParserRuleContext {
        ...
        public TerminalNode DESC() {
            return getToken(BlowEffectParser.DESC, 0);
        }

        public TerminalNode LCASE() {
            return getToken(BlowEffectParser.LCASE, 0);
        }
    ...
    public static class LoreColourBaseContext extends ParserRuleContext {
        ...
        public TerminalNode LORE_COLOUR_BASE() {
            return getToken(BlowEffectParser.LORE_COLOUR_BASE, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof BlowEffectVisitor)
                return ((BlowEffectVisitor<? extends T>) visitor).visitLoreColourBase(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class LoreColourResistContext extends ParserRuleContext {
        ...
        public TerminalNode LORE_COLOUR_RESIST() {
            return getToken(BlowEffectParser.LORE_COLOUR_RESIST, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof BlowEffectVisitor)
                return ((BlowEffectVisitor<? extends T>) visitor).visitLoreColourResist(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class LoreColourImmuneContext extends ParserRuleContext {
        ...
        public TerminalNode LORE_COLOUR_IMMUNE() {
            return getToken(BlowEffectParser.LORE_COLOUR_IMMUNE, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof BlowEffectVisitor)
                return ((BlowEffectVisitor<? extends T>) visitor).visitLoreColourImmune(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class EffectTypeContext extends ParserRuleContext {
        ...
        public TerminalNode EFFECT_TYPE() {
            return getToken(BlowEffectParser.EFFECT_TYPE, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof BlowEffectVisitor)
                return ((BlowEffectVisitor<? extends T>) visitor).visitEffectType(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ResistContext extends ParserRuleContext {
        public ElementEnum res;
        public Token UCASE;

        public TerminalNode RESIST() {
            return getToken(BlowEffectParser.RESIST, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof BlowEffectVisitor)
                return ((BlowEffectVisitor<? extends T>) visitor).visitResist(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public final ResistContext resist() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                ((ResistContext) _localctx).res = ElementEnum.valueOf("ELEM_" + raw);
    ...
    public static class LashTypeContext extends ParserRuleContext {
        public ElementEnum las;
        public Token UCASE;

        public TerminalNode LASH_TYPE() {
            return getToken(BlowEffectParser.LASH_TYPE, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof BlowEffectVisitor)
                return ((BlowEffectVisitor<? extends T>) visitor).visitLashType(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public final LashTypeContext lashType() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                String raw = ((LashTypeContext) _localctx).UCASE.getText();
                ((LashTypeContext) _localctx).las = ElementEnum.valueOf("ELEM_" + raw);
    ...
    public static class BlowEffectContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof BlowEffectVisitor)
                return ((BlowEffectVisitor<? extends T>) visitor).visitBlowEffect(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public final BlowEffectContext blowEffect() throws RecognitionException {
        ...
        try {
                ...
                do {
                    {
                        ...
                        switch (_input.LA(1)) {
                            ...
                            case LASH_TYPE: {
                                ...
                                lashTypeInit = ((BlowEffectContext) _localctx).lashType.las;
                            }
                            break;
                            default:
            ...
            ((BlowEffectContext) _localctx).effect = new BlowEffect(nameInit, powerInit, evalInit, descInit, baseInit, resistColInit, immuneInit, effectInit,
    ...
    public static class FileContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(BlowEffectParser.EOF, 0);
        }
