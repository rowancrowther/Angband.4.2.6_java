...
// Generated from C:/Users/rowan/Documents/IntelliJProjects/Angband.4.2.6/src/main/java/uk/co/jackoftradesltd/backend/parser/grammars/MonsterBaseGrammar.g4 by ANTLR 4.13.2
package uk.co.jackoftradesltd.backend.parser.grammars.monsterbase;
...
public class MonsterBaseGrammar extends Parser {
    ...
    public static class RecordCountContext extends ParserRuleContext {
        ...
        public TerminalNode RECORD_COUNT() {
            return getToken(MonsterBaseGrammar.RECORD_COUNT, 0);
        }

        public TerminalNode INTEGER() {
            return getToken(MonsterBaseGrammar.INTEGER, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof MonsterBaseGrammarListener)
                ((MonsterBaseGrammarListener) listener).enterRecordCount(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof MonsterBaseGrammarListener)
                ((MonsterBaseGrammarListener) listener).exitRecordCount(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof MonsterBaseGrammarVisitor)
                return ((MonsterBaseGrammarVisitor<? extends T>) visitor).visitRecordCount(this);
    ...
    public static class NameContext extends ParserRuleContext {
        ...
        public TerminalNode NAME() {
            return getToken(MonsterBaseGrammar.NAME, 0);
        }

        public TerminalNode STRING() {
            return getToken(MonsterBaseGrammar.STRING, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof MonsterBaseGrammarVisitor)
                return ((MonsterBaseGrammarVisitor<? extends T>) visitor).visitName(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class GlyphContext extends ParserRuleContext {
        ...
        public TerminalNode GLYPH() {
            return getToken(MonsterBaseGrammar.GLYPH, 0);
        }

        public TerminalNode SINGLE_CHAR() {
            return getToken(MonsterBaseGrammar.SINGLE_CHAR, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof MonsterBaseGrammarListener)
                ((MonsterBaseGrammarListener) listener).enterGlyph(this);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof MonsterBaseGrammarVisitor)
                return ((MonsterBaseGrammarVisitor<? extends T>) visitor).visitGlyph(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class PainContext extends ParserRuleContext {
        ...
        public TerminalNode PAIN() {
            return getToken(MonsterBaseGrammar.PAIN, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof MonsterBaseGrammarVisitor)
                return ((MonsterBaseGrammarVisitor<? extends T>) visitor).visitPain(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class FlagsContext extends ParserRuleContext {
        ...
        public TerminalNode FLAGS() {
            return getToken(MonsterBaseGrammar.FLAGS, 0);
        }

        public TerminalNode FLAG_EOL() {
            return getToken(MonsterBaseGrammar.FLAG_EOL, 0);
        }

        public List<TerminalNode> FLAG() {
            return getTokens(MonsterBaseGrammar.FLAG);
        }
        ...
        public List<TerminalNode> FLAG_OR() {
            return getTokens(MonsterBaseGrammar.FLAG_OR);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof MonsterBaseGrammarListener)
                ((MonsterBaseGrammarListener) listener).enterFlags(this);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof MonsterBaseGrammarVisitor)
                return ((MonsterBaseGrammarVisitor<? extends T>) visitor).visitFlags(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class DescContext extends ParserRuleContext {
        ...
        public List<TerminalNode> DESC() {
            return getTokens(MonsterBaseGrammar.DESC);
        }
        ...
        public List<TerminalNode> STRING() {
            return getTokens(MonsterBaseGrammar.STRING);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof MonsterBaseGrammarVisitor)
                return ((MonsterBaseGrammarVisitor<? extends T>) visitor).visitDesc(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class MonsterBaseContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof MonsterBaseGrammarListener)
                ((MonsterBaseGrammarListener) listener).enterMonsterBase(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof MonsterBaseGrammarListener)
                ((MonsterBaseGrammarListener) listener).exitMonsterBase(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof MonsterBaseGrammarVisitor)
                return ((MonsterBaseGrammarVisitor<? extends T>) visitor).visitMonsterBase(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class FileContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(MonsterBaseGrammar.EOF, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof MonsterBaseGrammarVisitor)
                return ((MonsterBaseGrammarVisitor<? extends T>) visitor).visitFile(this);
            else return visitor.visitChildren(this);
        }
    }
