...
package uk.co.jackoftradesltd.backend.parser.grammars.playerrace;
...
import uk.co.jackoftradesltd.backend.parser.playerrace.PlayerRaceParseRecord;
...
public class PlayerRaceGrammar extends Parser {
    ...
    public static class RecordCountContext extends ParserRuleContext {
        ...
        public TerminalNode RECORD_COUNT() {
            return getToken(PlayerRaceGrammar.RECORD_COUNT, 0);
        }

        public TerminalNode INTEGER() {
            return getToken(PlayerRaceGrammar.INTEGER, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PlayerRaceGrammarListener)
                ((PlayerRaceGrammarListener) listener).enterRecordCount(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PlayerRaceGrammarListener)
                ((PlayerRaceGrammarListener) listener).exitRecordCount(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PlayerRaceGrammarVisitor)
                return ((PlayerRaceGrammarVisitor<? extends T>) visitor).visitRecordCount(this);
    ...
    public static class NameContext extends ParserRuleContext {
        ...
        public TerminalNode NAME() {
            return getToken(PlayerRaceGrammar.NAME, 0);
        }

        public TerminalNode STRING() {
            return getToken(PlayerRaceGrammar.STRING, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PlayerRaceGrammarVisitor)
                return ((PlayerRaceGrammarVisitor<? extends T>) visitor).visitName(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class StatsContext extends ParserRuleContext {
        ...
        public TerminalNode STATS() {
            return getToken(PlayerRaceGrammar.STATS, 0);
        }

        public List<TerminalNode> COLON() {
            return getTokens(PlayerRaceGrammar.COLON);
        }
        ...
        public List<TerminalNode> INTEGER() {
            return getTokens(PlayerRaceGrammar.INTEGER);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PlayerRaceGrammarVisitor)
                return ((PlayerRaceGrammarVisitor<? extends T>) visitor).visitStats(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class SkillDisarmPhysContext extends ParserRuleContext {
        ...
        public TerminalNode SKILL_DISARM_PHYS() {
            return getToken(PlayerRaceGrammar.SKILL_DISARM_PHYS, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PlayerRaceGrammarListener)
                ((PlayerRaceGrammarListener) listener).enterSkillDisarmPhys(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PlayerRaceGrammarListener)
                ((PlayerRaceGrammarListener) listener).exitSkillDisarmPhys(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PlayerRaceGrammarVisitor)
                return ((PlayerRaceGrammarVisitor<? extends T>) visitor).visitSkillDisarmPhys(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class SkillDisarmMagicContext extends ParserRuleContext {
        ...
        public TerminalNode SKILL_DISARM_MAGIC() {
            return getToken(PlayerRaceGrammar.SKILL_DISARM_MAGIC, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PlayerRaceGrammarListener)
                ((PlayerRaceGrammarListener) listener).enterSkillDisarmMagic(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PlayerRaceGrammarListener)
                ((PlayerRaceGrammarListener) listener).exitSkillDisarmMagic(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PlayerRaceGrammarVisitor)
                return ((PlayerRaceGrammarVisitor<? extends T>) visitor).visitSkillDisarmMagic(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class SkillDeviceContext extends ParserRuleContext {
        ...
        public TerminalNode SKILL_DEVICE() {
            return getToken(PlayerRaceGrammar.SKILL_DEVICE, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PlayerRaceGrammarListener)
                ((PlayerRaceGrammarListener) listener).enterSkillDevice(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PlayerRaceGrammarListener)
                ((PlayerRaceGrammarListener) listener).exitSkillDevice(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PlayerRaceGrammarVisitor)
                return ((PlayerRaceGrammarVisitor<? extends T>) visitor).visitSkillDevice(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class SkillSaveContext extends ParserRuleContext {
        ...
        public TerminalNode SKILL_SAVE() {
            return getToken(PlayerRaceGrammar.SKILL_SAVE, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PlayerRaceGrammarListener)
                ((PlayerRaceGrammarListener) listener).enterSkillSave(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PlayerRaceGrammarListener)
                ((PlayerRaceGrammarListener) listener).exitSkillSave(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PlayerRaceGrammarVisitor)
                return ((PlayerRaceGrammarVisitor<? extends T>) visitor).visitSkillSave(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class SkillStealthContext extends ParserRuleContext {
        ...
        public TerminalNode SKILL_STEALTH() {
            return getToken(PlayerRaceGrammar.SKILL_STEALTH, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PlayerRaceGrammarListener)
                ((PlayerRaceGrammarListener) listener).enterSkillStealth(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PlayerRaceGrammarListener)
                ((PlayerRaceGrammarListener) listener).exitSkillStealth(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PlayerRaceGrammarVisitor)
                return ((PlayerRaceGrammarVisitor<? extends T>) visitor).visitSkillStealth(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class SkillSearchContext extends ParserRuleContext {
        ...
        public TerminalNode SKILL_SEARCH() {
            return getToken(PlayerRaceGrammar.SKILL_SEARCH, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PlayerRaceGrammarListener)
                ((PlayerRaceGrammarListener) listener).enterSkillSearch(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PlayerRaceGrammarListener)
                ((PlayerRaceGrammarListener) listener).exitSkillSearch(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PlayerRaceGrammarVisitor)
                return ((PlayerRaceGrammarVisitor<? extends T>) visitor).visitSkillSearch(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class SkillMeleeContext extends ParserRuleContext {
        ...
        public TerminalNode SKILL_MELEE() {
            return getToken(PlayerRaceGrammar.SKILL_MELEE, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PlayerRaceGrammarListener)
                ((PlayerRaceGrammarListener) listener).enterSkillMelee(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PlayerRaceGrammarListener)
                ((PlayerRaceGrammarListener) listener).exitSkillMelee(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PlayerRaceGrammarVisitor)
                return ((PlayerRaceGrammarVisitor<? extends T>) visitor).visitSkillMelee(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class SkillShootContext extends ParserRuleContext {
        ...
        public TerminalNode SKILL_SHOOT() {
            return getToken(PlayerRaceGrammar.SKILL_SHOOT, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PlayerRaceGrammarListener)
                ((PlayerRaceGrammarListener) listener).enterSkillShoot(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PlayerRaceGrammarListener)
                ((PlayerRaceGrammarListener) listener).exitSkillShoot(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PlayerRaceGrammarVisitor)
                return ((PlayerRaceGrammarVisitor<? extends T>) visitor).visitSkillShoot(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class SkillThrowContext extends ParserRuleContext {
        ...
        public TerminalNode SKILL_THROW() {
            return getToken(PlayerRaceGrammar.SKILL_THROW, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PlayerRaceGrammarListener)
                ((PlayerRaceGrammarListener) listener).enterSkillThrow(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PlayerRaceGrammarListener)
                ((PlayerRaceGrammarListener) listener).exitSkillThrow(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PlayerRaceGrammarVisitor)
                return ((PlayerRaceGrammarVisitor<? extends T>) visitor).visitSkillThrow(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class SkillDigContext extends ParserRuleContext {
        ...
        public TerminalNode SKILL_DIG() {
            return getToken(PlayerRaceGrammar.SKILL_DIG, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PlayerRaceGrammarListener)
                ((PlayerRaceGrammarListener) listener).enterSkillDig(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PlayerRaceGrammarListener)
                ((PlayerRaceGrammarListener) listener).exitSkillDig(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PlayerRaceGrammarVisitor)
                return ((PlayerRaceGrammarVisitor<? extends T>) visitor).visitSkillDig(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class HitdieContext extends ParserRuleContext {
        ...
        public TerminalNode HITDIE() {
            return getToken(PlayerRaceGrammar.HITDIE, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PlayerRaceGrammarVisitor)
                return ((PlayerRaceGrammarVisitor<? extends T>) visitor).visitHitdie(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ExpContext extends ParserRuleContext {
        ...
        public TerminalNode EXP() {
            return getToken(PlayerRaceGrammar.EXP, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PlayerRaceGrammarVisitor)
                return ((PlayerRaceGrammarVisitor<? extends T>) visitor).visitExp(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class InfravisionContext extends ParserRuleContext {
        ...
        public TerminalNode INFRAVISION() {
            return getToken(PlayerRaceGrammar.INFRAVISION, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PlayerRaceGrammarListener)
                ((PlayerRaceGrammarListener) listener).enterInfravision(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PlayerRaceGrammarListener)
                ((PlayerRaceGrammarListener) listener).exitInfravision(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PlayerRaceGrammarVisitor)
                return ((PlayerRaceGrammarVisitor<? extends T>) visitor).visitInfravision(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class HistoryContext extends ParserRuleContext {
        ...
        public TerminalNode HISTORY() {
            return getToken(PlayerRaceGrammar.HISTORY, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PlayerRaceGrammarListener)
                ((PlayerRaceGrammarListener) listener).enterHistory(this);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PlayerRaceGrammarVisitor)
                return ((PlayerRaceGrammarVisitor<? extends T>) visitor).visitHistory(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class AgeContext extends ParserRuleContext {
        ...
        public TerminalNode AGE() {
            return getToken(PlayerRaceGrammar.AGE, 0);
        }

        public TerminalNode COLON() {
            return getToken(PlayerRaceGrammar.COLON, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PlayerRaceGrammarVisitor)
                return ((PlayerRaceGrammarVisitor<? extends T>) visitor).visitAge(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class HeightContext extends ParserRuleContext {
        ...
        public TerminalNode HEIGHT() {
            return getToken(PlayerRaceGrammar.HEIGHT, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PlayerRaceGrammarVisitor)
                return ((PlayerRaceGrammarVisitor<? extends T>) visitor).visitHeight(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class WeightContext extends ParserRuleContext {
        ...
        public TerminalNode WEIGHT() {
            return getToken(PlayerRaceGrammar.WEIGHT, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PlayerRaceGrammarVisitor)
                return ((PlayerRaceGrammarVisitor<? extends T>) visitor).visitWeight(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ObjFlagsContext extends ParserRuleContext {
        ...
        public TerminalNode OBJ_FLAGS() {
            return getToken(PlayerRaceGrammar.OBJ_FLAGS, 0);
        }

        public List<TerminalNode> FLAG() {
            return getTokens(PlayerRaceGrammar.FLAG);
        }
        ...
        public List<TerminalNode> FLAG_OR() {
            return getTokens(PlayerRaceGrammar.FLAG_OR);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PlayerRaceGrammarListener)
                ((PlayerRaceGrammarListener) listener).enterObjFlags(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PlayerRaceGrammarListener)
                ((PlayerRaceGrammarListener) listener).exitObjFlags(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PlayerRaceGrammarVisitor)
                return ((PlayerRaceGrammarVisitor<? extends T>) visitor).visitObjFlags(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class PlayerFlagsContext extends ParserRuleContext {
        ...
        public TerminalNode PLAYER_FLAGS() {
            return getToken(PlayerRaceGrammar.PLAYER_FLAGS, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PlayerRaceGrammarListener)
                ((PlayerRaceGrammarListener) listener).enterPlayerFlags(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PlayerRaceGrammarListener)
                ((PlayerRaceGrammarListener) listener).exitPlayerFlags(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PlayerRaceGrammarVisitor)
                return ((PlayerRaceGrammarVisitor<? extends T>) visitor).visitPlayerFlags(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ValuesContext extends ParserRuleContext {
        ...
        public TerminalNode VALUES() {
            return getToken(PlayerRaceGrammar.VALUES, 0);
        }

        public List<TerminalNode> VALUE_LBRACKET() {
            return getTokens(PlayerRaceGrammar.VALUE_LBRACKET);
        }
        ...
        public List<TerminalNode> VALUE_RBRACKET() {
            return getTokens(PlayerRaceGrammar.VALUE_RBRACKET);
        }
        ...
        public List<TerminalNode> VALUE_NAME() {
            return getTokens(PlayerRaceGrammar.VALUE_NAME);
        }
        ...
        public List<TerminalNode> VALUE_INT() {
            return getTokens(PlayerRaceGrammar.VALUE_INT);
        }
        ...
        public List<TerminalNode> VALUE_OR() {
            return getTokens(PlayerRaceGrammar.VALUE_OR);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PlayerRaceGrammarVisitor)
                return ((PlayerRaceGrammarVisitor<? extends T>) visitor).visitValues(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class PlayerRaceContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_playerRace;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PlayerRaceGrammarListener)
                ((PlayerRaceGrammarListener) listener).enterPlayerRace(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PlayerRaceGrammarListener)
                ((PlayerRaceGrammarListener) listener).exitPlayerRace(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PlayerRaceGrammarVisitor)
                return ((PlayerRaceGrammarVisitor<? extends T>) visitor).visitPlayerRace(this);
            else return visitor.visitChildren(this);
        }
    }
                ...
                do {
                    {
                        ...
                        switch (_input.LA(1)) {
                            ...
                            case AGE: {
                                ...
                                ageBaseInit = ((PlayerRaceContext) _localctx).age.ageBase;
                                ageModifierInit = ((PlayerRaceContext) _localctx).age.ageMod;
                            }
                            break;
                            case HEIGHT: {
                                setState(237);
                                ((PlayerRaceContext) _localctx).height = height();
                                heightBaseInit = ((PlayerRaceContext) _localctx).height.heightBase;
                                heightModifierInit = ((PlayerRaceContext) _localctx).height.heightMod;
                            }
                            break;
                            case WEIGHT: {
                                setState(240);
                                ((PlayerRaceContext) _localctx).weight = weight();
                                weightBaseInit = ((PlayerRaceContext) _localctx).weight.weightBase;
                                weightModifierInit = ((PlayerRaceContext) _localctx).weight.weightMod;
                            }
                            break;
                            case OBJ_FLAGS: {
                                setState(243);
    ...
    public static class FileContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(PlayerRaceGrammar.EOF, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PlayerRaceGrammarVisitor)
                return ((PlayerRaceGrammarVisitor<? extends T>) visitor).visitFile(this);
            else return visitor.visitChildren(this);
        }
    }
