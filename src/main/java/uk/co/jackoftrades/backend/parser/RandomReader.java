...
import uk.co.jackoftrades.backend.parser.random.RandomLexer;
import uk.co.jackoftrades.backend.parser.random.RandomParser;
 ...
 * @author ClaudeCode
 */
public class RandomReader implements Parser<Random> {
    /**
