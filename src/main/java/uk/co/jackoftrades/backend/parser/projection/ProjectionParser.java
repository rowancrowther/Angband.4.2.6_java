...
public class ProjectionParser extends Parser {
    ...
    public static class CodeContext extends ParserRuleContext {
        ...
        public TerminalNode CODE() {
            return getToken(ProjectionParser.CODE, 0);
        }

        public TerminalNode UCASE() {
            return getToken(ProjectionParser.UCASE, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).enterCode(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).exitCode(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionVisitor) return ((ProjectionVisitor<? extends T>) visitor).visitCode(this);
    ...
    public static class NameContext extends ParserRuleContext {
        ...
        public TerminalNode NAME() {
            return getToken(ProjectionParser.NAME, 0);
        }

        public TerminalNode LWORDS() {
            return getToken(ProjectionParser.LWORDS, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).enterName(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).exitName(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionVisitor) return ((ProjectionVisitor<? extends T>) visitor).visitName(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class TypeContext extends ParserRuleContext {
        ...
        public TerminalNode TYPE() {
            return getToken(ProjectionParser.TYPE, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).enterType(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).exitType(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionVisitor) return ((ProjectionVisitor<? extends T>) visitor).visitType(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class DescContext extends ParserRuleContext {
        ...
        public TerminalNode DESC() {
            return getToken(ProjectionParser.DESC, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).enterDesc(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).exitDesc(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionVisitor) return ((ProjectionVisitor<? extends T>) visitor).visitDesc(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class PlayerDescContext extends ParserRuleContext {
        ...
        public TerminalNode PLAYER_DESC() {
            return getToken(ProjectionParser.PLAYER_DESC, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).enterPlayerDesc(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).exitPlayerDesc(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionVisitor)
                return ((ProjectionVisitor<? extends T>) visitor).visitPlayerDesc(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class BlindDescContext extends ParserRuleContext {
        ...
        public TerminalNode BLIND_DESC() {
            return getToken(ProjectionParser.BLIND_DESC, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).enterBlindDesc(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).exitBlindDesc(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionVisitor)
                return ((ProjectionVisitor<? extends T>) visitor).visitBlindDesc(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class LashDescContext extends ParserRuleContext {
        ...
        public TerminalNode LASH_DESC() {
            return getToken(ProjectionParser.LASH_DESC, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).enterLashDesc(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).exitLashDesc(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionVisitor)
                return ((ProjectionVisitor<? extends T>) visitor).visitLashDesc(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class NumeratorContext extends ParserRuleContext {
        ...
        public TerminalNode NUMERATOR() {
            return getToken(ProjectionParser.NUMERATOR, 0);
        }

        public TerminalNode NUMBER() {
            return getToken(ProjectionParser.NUMBER, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).enterNumerator(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).exitNumerator(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionVisitor)
                return ((ProjectionVisitor<? extends T>) visitor).visitNumerator(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class DiceContext extends ParserRuleContext {
        ...
        public List<TerminalNode> NUMBER() {
            return getTokens(ProjectionParser.NUMBER);
        }

        public TerminalNode NUMBER(int i) {
            return getToken(ProjectionParser.NUMBER, i);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).enterDice(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).exitDice(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionVisitor) return ((ProjectionVisitor<? extends T>) visitor).visitDice(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class DenominatorContext extends ParserRuleContext {
        ...
        public TerminalNode DENOMINATOR() {
            return getToken(ProjectionParser.DENOMINATOR, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).enterDenominator(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).exitDenominator(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionVisitor)
                return ((ProjectionVisitor<? extends T>) visitor).visitDenominator(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class DivisorContext extends ParserRuleContext {
        ...
        public TerminalNode DIVISOR() {
            return getToken(ProjectionParser.DIVISOR, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).enterDivisor(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).exitDivisor(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionVisitor)
                return ((ProjectionVisitor<? extends T>) visitor).visitDivisor(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class DamageCapContext extends ParserRuleContext {
        ...
        public TerminalNode DAMAGE_CAP() {
            return getToken(ProjectionParser.DAMAGE_CAP, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).enterDamageCap(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).exitDamageCap(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionVisitor)
                return ((ProjectionVisitor<? extends T>) visitor).visitDamageCap(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class MsgtContext extends ParserRuleContext {
        ...
        public TerminalNode MSGT() {
            return getToken(ProjectionParser.MSGT, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).enterMsgt(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).exitMsgt(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionVisitor) return ((ProjectionVisitor<? extends T>) visitor).visitMsgt(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ObviousContext extends ParserRuleContext {
        ...
        public TerminalNode OBVIOUS() {
            return getToken(ProjectionParser.OBVIOUS, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).enterObvious(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).exitObvious(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionVisitor)
                return ((ProjectionVisitor<? extends T>) visitor).visitObvious(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class WakeContext extends ParserRuleContext {
        ...
        public TerminalNode WAKE() {
            return getToken(ProjectionParser.WAKE, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).enterWake(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).exitWake(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionVisitor) return ((ProjectionVisitor<? extends T>) visitor).visitWake(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ColourContext extends ParserRuleContext {
        ...
        public TerminalNode COLOUR() {
            return getToken(ProjectionParser.COLOUR, 0);
        }

        public TerminalNode TCASE() {
            return getToken(ProjectionParser.TCASE, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).enterColour(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).exitColour(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionVisitor)
                return ((ProjectionVisitor<? extends T>) visitor).visitColour(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ProjectionContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionVisitor)
                return ((ProjectionVisitor<? extends T>) visitor).visitProjection(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class FileContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(ProjectionParser.EOF, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).enterFile(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionListener) ((ProjectionListener) listener).exitFile(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionVisitor) return ((ProjectionVisitor<? extends T>) visitor).visitFile(this);
            else return visitor.visitChildren(this);
        }
    }
