...
public class Worlds extends Parser {
    static {
    ...
    public Worlds(TokenStream input) {
        super(input);
    ...
    public static class RecordCountContext extends ParserRuleContext {
        ...
        public TerminalNode RECORD_COUNT() {
            return getToken(Worlds.RECORD_COUNT, 0);
        }

        public TerminalNode INTEGER() {
            return getToken(Worlds.INTEGER, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof WorldsListener) ((WorldsListener) listener).enterRecordCount(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof WorldsListener) ((WorldsListener) listener).exitRecordCount(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof WorldsVisitor) return ((WorldsVisitor<? extends T>) visitor).visitRecordCount(this);
    ...
    public static class LevelNumContext extends ParserRuleContext {
        ...
        public TerminalNode COLON() {
            return getToken(Worlds.COLON, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof WorldsListener) ((WorldsListener) listener).enterLevelNum(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof WorldsListener) ((WorldsListener) listener).exitLevelNum(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof WorldsVisitor) return ((WorldsVisitor<? extends T>) visitor).visitLevelNum(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class LevelNameContext extends ParserRuleContext {
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof WorldsListener) ((WorldsListener) listener).enterLevelName(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof WorldsListener) ((WorldsListener) listener).exitLevelName(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof WorldsVisitor) return ((WorldsVisitor<? extends T>) visitor).visitLevelName(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class UpAndDownContext extends ParserRuleContext {
        ...
        public List<TerminalNode> NAME() {
            return getTokens(Worlds.NAME);
        }

        public TerminalNode NAME(int i) {
            return getToken(Worlds.NAME, i);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof WorldsListener) ((WorldsListener) listener).enterUpAndDown(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof WorldsListener) ((WorldsListener) listener).exitUpAndDown(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof WorldsVisitor) return ((WorldsVisitor<? extends T>) visitor).visitUpAndDown(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class LineContext extends ParserRuleContext {
        ...
        public TerminalNode LEVEL() {
            return getToken(Worlds.LEVEL, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof WorldsListener) ((WorldsListener) listener).enterLine(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof WorldsListener) ((WorldsListener) listener).exitLine(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof WorldsVisitor) return ((WorldsVisitor<? extends T>) visitor).visitLine(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class FileContext extends ParserRuleContext {
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof WorldsListener) ((WorldsListener) listener).enterFile(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof WorldsListener) ((WorldsListener) listener).exitFile(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof WorldsVisitor) return ((WorldsVisitor<? extends T>) visitor).visitFile(this);
            else return visitor.visitChildren(this);
        }
    }
