 ...
 */
// Generated from PlayerRaceLexer.g4 by ANTLR 4.13.2
...
public class PlayerRaceLexer extends Lexer {
    static {
    ...
    public static final int
            FREE_TEXT_MODE = 1, FLAG_MODE = 2, VALUE_MODE = 3;
    public static String[] channelNames = {
            "DEFAULT_TOKEN_CHANNEL", "HIDDEN"
    };

    public static String[] modeNames = {
            "DEFAULT_MODE", "FREE_TEXT_MODE", "FLAG_MODE", "VALUE_MODE"
    };

    private static String[] makeRuleNames() {
        return new String[]{
                "RECORD_COUNT", "NAME", "STATS", "SKILL_DISARM_PHYS", "SKILL_DISARM_MAGIC",
                ...
                "INTEGER", "COLON", "COMMENT", "EOL", "FLAG_BODY", "STRING", "FREE_TEXT_EOL",
                "FLAG", "FLAG_OR", "FLAG_EOL", "VALUE_NAME", "VALUE_LBRACKET", "VALUE_INT",
                "VALUE_RBRACKET", "VALUE_OR", "VALUE_EOL"
        };
    }
    ...
    public PlayerRaceLexer(CharStream input) {
        super(input);
