...
/**
 * Builds a lesser vault of the newer style — the port of C's {@code build_lesser_new_vault}.
 *
 * <p>Same size limit as {@link LesserVault}, at most 22x22, but drawn from the newer set of layouts
 ...
 */
public class NewLesserVault implements RoomBuilder {
    /**
     * {@inheritDoc}
     *
