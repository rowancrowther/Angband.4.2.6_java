 ...
 */
// Generated from ObjectPropertyLexer.g4 by ANTLR 4.13.2
...
public class ObjectPropertyLexer extends Lexer {
    ...
    public static final int
            FREE_TEXT_MODE = 1, DELIMITER = 2;
    public static String[] channelNames = {
            "DEFAULT_TOKEN_CHANNEL", "HIDDEN"
    };

    public static String[] modeNames = {
            "DEFAULT_MODE", "FREE_TEXT_MODE", "DELIMITER"
    };

    private static String[] makeRuleNames() {
        return new String[]{
                "RECORD_COUNT", "NAME", "TYPE", "SUBTYPE", "ID_TYPE", "CODE", "POWER",
                "MULT", "TYPE_MULT", "ADJECTIVE", "NEG_ADJECTIVE", "MSG", "BINDUI", "DESC",
                "COLON", "INTEGER", "LTHAN", "GTHAN", "LCASE", "UCASE", "COMMENT", "EOL",
                "FLAG_BODY", "STRING", "EOL_POP", "DELIM_INTEGER", "STRING_BETWEEN_COLONS",
                "DELIM_COLON", "END_SKIP"
        };
    }
