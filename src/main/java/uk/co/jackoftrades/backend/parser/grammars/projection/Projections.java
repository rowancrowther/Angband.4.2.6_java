...
public class Projections extends Parser {
    static {
    ...
    public Projections(TokenStream input) {
        super(input);
    ...
    public static class RecordCountContext extends ParserRuleContext {
        ...
        public TerminalNode RECORD_COUNT() {
            return getToken(Projections.RECORD_COUNT, 0);
        }

        public TerminalNode INTEGER() {
            return getToken(Projections.INTEGER, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).enterRecordCount(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).exitRecordCount(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionsVisitor)
                return ((ProjectionsVisitor<? extends T>) visitor).visitRecordCount(this);
    ...
    public static class CodeContext extends ParserRuleContext {
        ...
        public TerminalNode CODE() {
            return getToken(Projections.CODE, 0);
        }

        public TerminalNode TAG() {
            return getToken(Projections.TAG, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).enterCode(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).exitCode(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionsVisitor)
                return ((ProjectionsVisitor<? extends T>) visitor).visitCode(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public final CodeContext code() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                ((CodeContext) _localctx).projectionCode = ((CodeContext) _localctx).TAG.getText();
    ...
    public static class NameContext extends ParserRuleContext {
        ...
        public TerminalNode NAME() {
            return getToken(Projections.NAME, 0);
        }

        public TerminalNode STRING() {
            return getToken(Projections.STRING, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).enterName(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).exitName(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionsVisitor)
                return ((ProjectionsVisitor<? extends T>) visitor).visitName(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class TypeContext extends ParserRuleContext {
        ...
        public TerminalNode TYPE() {
            return getToken(Projections.TYPE, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).enterType(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).exitType(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionsVisitor)
                return ((ProjectionsVisitor<? extends T>) visitor).visitType(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class DescContext extends ParserRuleContext {
        ...
        public TerminalNode DESC() {
            return getToken(Projections.DESC, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).enterDesc(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).exitDesc(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionsVisitor)
                return ((ProjectionsVisitor<? extends T>) visitor).visitDesc(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class PlayerDescContext extends ParserRuleContext {
        ...
        public TerminalNode PLAYER_DESC() {
            return getToken(Projections.PLAYER_DESC, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).enterPlayerDesc(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).exitPlayerDesc(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionsVisitor)
                return ((ProjectionsVisitor<? extends T>) visitor).visitPlayerDesc(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class BlindDescContext extends ParserRuleContext {
        ...
        public TerminalNode BLIND_DESC() {
            return getToken(Projections.BLIND_DESC, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).enterBlindDesc(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).exitBlindDesc(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionsVisitor)
                return ((ProjectionsVisitor<? extends T>) visitor).visitBlindDesc(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class LashDescContext extends ParserRuleContext {
        ...
        public TerminalNode LASH_DESC() {
            return getToken(Projections.LASH_DESC, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).enterLashDesc(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).exitLashDesc(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionsVisitor)
                return ((ProjectionsVisitor<? extends T>) visitor).visitLashDesc(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class NumeratorContext extends ParserRuleContext {
        ...
        public TerminalNode NUMERATOR() {
            return getToken(Projections.NUMERATOR, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).enterNumerator(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).exitNumerator(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionsVisitor)
                return ((ProjectionsVisitor<? extends T>) visitor).visitNumerator(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class DenominatorContext extends ParserRuleContext {
        ...
        public TerminalNode DENOMINATOR() {
            return getToken(Projections.DENOMINATOR, 0);
        }

        public TerminalNode SIMPLE_DICE() {
            return getToken(Projections.SIMPLE_DICE, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).enterDenominator(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).exitDenominator(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionsVisitor)
                return ((ProjectionsVisitor<? extends T>) visitor).visitDenominator(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class DivisorContext extends ParserRuleContext {
        ...
        public TerminalNode DIVISOR() {
            return getToken(Projections.DIVISOR, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).enterDivisor(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).exitDivisor(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionsVisitor)
                return ((ProjectionsVisitor<? extends T>) visitor).visitDivisor(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class DamageCapContext extends ParserRuleContext {
        ...
        public TerminalNode DAMAGE_CAP() {
            return getToken(Projections.DAMAGE_CAP, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).enterDamageCap(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).exitDamageCap(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionsVisitor)
                return ((ProjectionsVisitor<? extends T>) visitor).visitDamageCap(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class MsgtContext extends ParserRuleContext {
        ...
        public TerminalNode MSGT() {
            return getToken(Projections.MSGT, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).enterMsgt(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).exitMsgt(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionsVisitor)
                return ((ProjectionsVisitor<? extends T>) visitor).visitMsgt(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public final MsgtContext msgt() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                match(MSGT);
                setState(85);
                ((MsgtContext) _localctx).TAG = match(TAG);

                ((MsgtContext) _localctx).projectionMsgt = ((MsgtContext) _localctx).TAG.getText();
    ...
    public static class ObviousContext extends ParserRuleContext {
        ...
        public TerminalNode OBVIOUS() {
            return getToken(Projections.OBVIOUS, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).enterObvious(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).exitObvious(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionsVisitor)
                return ((ProjectionsVisitor<? extends T>) visitor).visitObvious(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class WakeContext extends ParserRuleContext {
        ...
        public TerminalNode WAKE() {
            return getToken(Projections.WAKE, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).enterWake(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).exitWake(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionsVisitor)
                return ((ProjectionsVisitor<? extends T>) visitor).visitWake(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ColourContext extends ParserRuleContext {
        ...
        public TerminalNode COLOUR() {
            return getToken(Projections.COLOUR, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).enterColour(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).exitColour(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionsVisitor)
                return ((ProjectionsVisitor<? extends T>) visitor).visitColour(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ProjectionContext extends ParserRuleContext {
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).enterProjection(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).exitProjection(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionsVisitor)
                return ((ProjectionsVisitor<? extends T>) visitor).visitProjection(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class FileContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(Projections.EOF, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).enterFile(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionsListener) ((ProjectionsListener) listener).exitFile(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionsVisitor)
                return ((ProjectionsVisitor<? extends T>) visitor).visitFile(this);
            else return visitor.visitChildren(this);
        }
    }
