 ...
 * cf WorldGrammar.g4's 'recordCount' rule.
 */
RECORD_COUNT
        :   'record-count:'
        ;
 ...
 * cf WorldGrammar.g4's 'line' rule.
 */
LEVEL   :   'level:'
        ;
 ...
 * cf WorldGrammar.g4's 'levelNum', 'levelName' and 'upAndDown' rules.
 */
COLON   :   ':'
        ;
 ...
 * field.
 * cf WorldGrammar.g4's 'recordCount' and 'levelNum' rules.
 */
INTEGER
        :  '-'? ('0'..'9')+
        ;
 ...
 * cf WorldGrammar.g4's 'levelName' and 'upAndDown' rules.
 */
NAME    :   ('A'..'Z'|'a'..'z'|' '|'0'..'9')+
        ;