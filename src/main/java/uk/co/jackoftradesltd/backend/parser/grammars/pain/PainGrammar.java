...
public class PainGrammar extends Parser {
    ...
    public static class RecordCountContext extends ParserRuleContext {
        ...
        public TerminalNode RECORD_COUNT() {
            return getToken(PainGrammar.RECORD_COUNT, 0);
        }

        public TerminalNode INTEGER() {
            return getToken(PainGrammar.INTEGER, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PainGrammarVisitor)
                return ((PainGrammarVisitor<? extends T>) visitor).visitRecordCount(this);
    ...
    public static class TypeContext extends ParserRuleContext {
        ...
        public TerminalNode TYPE() {
            return getToken(PainGrammar.TYPE, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PainGrammarVisitor)
                return ((PainGrammarVisitor<? extends T>) visitor).visitType(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class MessageContext extends ParserRuleContext {
        ...
        public TerminalNode MESSAGE() {
            return getToken(PainGrammar.MESSAGE, 0);
        }

        public TerminalNode STRING() {
            return getToken(PainGrammar.STRING, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PainGrammarVisitor)
                return ((PainGrammarVisitor<? extends T>) visitor).visitMessage(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class PainEntryContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PainGrammarVisitor)
                return ((PainGrammarVisitor<? extends T>) visitor).visitPainEntry(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class FileContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(PainGrammar.EOF, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PainGrammarVisitor)
                return ((PainGrammarVisitor<? extends T>) visitor).visitFile(this);
            else return visitor.visitChildren(this);
        }
    }
