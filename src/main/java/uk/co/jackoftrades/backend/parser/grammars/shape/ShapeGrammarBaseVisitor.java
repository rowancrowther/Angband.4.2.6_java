...
/**
 * This class provides an empty implementation of {@link ShapeGrammarVisitor},
...
public class ShapeGrammarBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements ShapeGrammarVisitor<T> {
	/**
	 * {@inheritDoc}
	 *
