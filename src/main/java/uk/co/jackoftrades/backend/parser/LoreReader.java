...
import uk.co.jackoftrades.backend.parser.lore.LoreGrammar;
import uk.co.jackoftrades.backend.parser.lore.LoreLexer;
...
/**
 * Loads the relevant data-file entries into {@link MonsterLore} objects by driving the
 ...
 * @author ClaudeCode
 */
public class LoreReader implements Parser<MonsterLore> {
    /**
