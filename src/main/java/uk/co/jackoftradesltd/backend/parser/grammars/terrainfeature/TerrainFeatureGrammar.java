...
package uk.co.jackoftradesltd.backend.parser.grammars.terrainfeature;
...
public class TerrainFeatureGrammar extends Parser {
    ...
    public String getGrammarFileName() {
        return "TerrainFeatureGrammar.g4";
    }
    ...
    public static class RecordCountContext extends ParserRuleContext {
        ...
        public TerminalNode RECORD_COUNT() {
            return getToken(TerrainFeatureGrammar.RECORD_COUNT, 0);
        }

        public TerminalNode INTEGER() {
            return getToken(TerrainFeatureGrammar.INTEGER, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).enterRecordCount(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).exitRecordCount(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof TerrainFeatureGrammarVisitor)
                return ((TerrainFeatureGrammarVisitor<? extends T>) visitor).visitRecordCount(this);
    ...
    public static class CodeContext extends ParserRuleContext {
        ...
        public TerminalNode CODE() {
            return getToken(TerrainFeatureGrammar.CODE, 0);
        }

        public TerminalNode FLAG() {
            return getToken(TerrainFeatureGrammar.FLAG, 0);
        }

        public TerminalNode FLAG_EOL() {
            return getToken(TerrainFeatureGrammar.FLAG_EOL, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).enterCode(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).exitCode(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof TerrainFeatureGrammarVisitor)
                return ((TerrainFeatureGrammarVisitor<? extends T>) visitor).visitCode(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class NameContext extends ParserRuleContext {
        ...
        public TerminalNode NAME() {
            return getToken(TerrainFeatureGrammar.NAME, 0);
        }

        public TerminalNode STRING() {
            return getToken(TerrainFeatureGrammar.STRING, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).enterName(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).exitName(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof TerrainFeatureGrammarVisitor)
                return ((TerrainFeatureGrammarVisitor<? extends T>) visitor).visitName(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class GraphicsContext extends ParserRuleContext {
        ...
        public TerminalNode GRAPHICS() {
            return getToken(TerrainFeatureGrammar.GRAPHICS, 0);
        }

        public TerminalNode GLYPH_COLON_SWITCH() {
            return getToken(TerrainFeatureGrammar.GLYPH_COLON_SWITCH, 0);
        }

        public TerminalNode GLYPH_VALUES() {
            return getToken(TerrainFeatureGrammar.GLYPH_VALUES, 0);
        }

        public TerminalNode COLOUR_VALUES() {
            return getToken(TerrainFeatureGrammar.COLOUR_VALUES, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).enterGraphics(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).exitGraphics(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof TerrainFeatureGrammarVisitor)
                return ((TerrainFeatureGrammarVisitor<? extends T>) visitor).visitGraphics(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class MimicContext extends ParserRuleContext {
        ...
        public TerminalNode MIMIC() {
            return getToken(TerrainFeatureGrammar.MIMIC, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).enterMimic(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).exitMimic(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof TerrainFeatureGrammarVisitor)
                return ((TerrainFeatureGrammarVisitor<? extends T>) visitor).visitMimic(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class PriorityContext extends ParserRuleContext {
        ...
        public TerminalNode PRIORITY() {
            return getToken(TerrainFeatureGrammar.PRIORITY, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).enterPriority(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).exitPriority(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof TerrainFeatureGrammarVisitor)
                return ((TerrainFeatureGrammarVisitor<? extends T>) visitor).visitPriority(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class FlagsContext extends ParserRuleContext {
        ...
        public TerminalNode FLAGS() {
            return getToken(TerrainFeatureGrammar.FLAGS, 0);
        }
        ...
        public List<TerminalNode> FLAG() {
            return getTokens(TerrainFeatureGrammar.FLAG);
        }
        ...
        public List<TerminalNode> FLAG_OR() {
            return getTokens(TerrainFeatureGrammar.FLAG_OR);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).enterFlags(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).exitFlags(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof TerrainFeatureGrammarVisitor)
                return ((TerrainFeatureGrammarVisitor<? extends T>) visitor).visitFlags(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class DiggingContext extends ParserRuleContext {
        ...
        public TerminalNode DIGGING() {
            return getToken(TerrainFeatureGrammar.DIGGING, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).enterDigging(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).exitDigging(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof TerrainFeatureGrammarVisitor)
                return ((TerrainFeatureGrammarVisitor<? extends T>) visitor).visitDigging(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Walk_messageContext extends ParserRuleContext {
        ...
        public TerminalNode WALK_MESSAGE() {
            return getToken(TerrainFeatureGrammar.WALK_MESSAGE, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_walk_message;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).enterWalk_message(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).exitWalk_message(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof TerrainFeatureGrammarVisitor)
                return ((TerrainFeatureGrammarVisitor<? extends T>) visitor).visitWalk_message(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Run_messageContext extends ParserRuleContext {
        ...
        public TerminalNode RUN_MESSAGE() {
            return getToken(TerrainFeatureGrammar.RUN_MESSAGE, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_run_message;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).enterRun_message(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).exitRun_message(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof TerrainFeatureGrammarVisitor)
                return ((TerrainFeatureGrammarVisitor<? extends T>) visitor).visitRun_message(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Hurt_messageContext extends ParserRuleContext {
        ...
        public TerminalNode HURT_MESSAGE() {
            return getToken(TerrainFeatureGrammar.HURT_MESSAGE, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_hurt_message;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).enterHurt_message(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).exitHurt_message(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof TerrainFeatureGrammarVisitor)
                return ((TerrainFeatureGrammarVisitor<? extends T>) visitor).visitHurt_message(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Die_messageContext extends ParserRuleContext {
        ...
        public TerminalNode DIE_MESSAGE() {
            return getToken(TerrainFeatureGrammar.DIE_MESSAGE, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_die_message;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).enterDie_message(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).exitDie_message(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof TerrainFeatureGrammarVisitor)
                return ((TerrainFeatureGrammarVisitor<? extends T>) visitor).visitDie_message(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Confused_messageContext extends ParserRuleContext {
        ...
        public TerminalNode CONFUSED_MESSAGE() {
            return getToken(TerrainFeatureGrammar.CONFUSED_MESSAGE, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_confused_message;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).enterConfused_message(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).exitConfused_message(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof TerrainFeatureGrammarVisitor)
                return ((TerrainFeatureGrammarVisitor<? extends T>) visitor).visitConfused_message(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Look_prefixContext extends ParserRuleContext {
        ...
        public TerminalNode LOOK_PREFIX() {
            return getToken(TerrainFeatureGrammar.LOOK_PREFIX, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).enterLook_prefix(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).exitLook_prefix(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof TerrainFeatureGrammarVisitor)
                return ((TerrainFeatureGrammarVisitor<? extends T>) visitor).visitLook_prefix(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Look_in_prepositionContext extends ParserRuleContext {
        ...
        public TerminalNode LOOK_IN_PREPOSITION() {
            return getToken(TerrainFeatureGrammar.LOOK_IN_PREPOSITION, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).enterLook_in_preposition(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).exitLook_in_preposition(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof TerrainFeatureGrammarVisitor)
                return ((TerrainFeatureGrammarVisitor<? extends T>) visitor).visitLook_in_preposition(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Resist_flagContext extends ParserRuleContext {
        ...
        public TerminalNode RESIST_FLAG() {
            return getToken(TerrainFeatureGrammar.RESIST_FLAG, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).enterResist_flag(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).exitResist_flag(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof TerrainFeatureGrammarVisitor)
                return ((TerrainFeatureGrammarVisitor<? extends T>) visitor).visitResist_flag(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class DescContext extends ParserRuleContext {
        ...
        public List<TerminalNode> DESC() {
            return getTokens(TerrainFeatureGrammar.DESC);
        }
        ...
        public List<TerminalNode> STRING() {
            return getTokens(TerrainFeatureGrammar.STRING);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).enterDesc(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).exitDesc(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof TerrainFeatureGrammarVisitor)
                return ((TerrainFeatureGrammarVisitor<? extends T>) visitor).visitDesc(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class TerrainContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).enterTerrain(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).exitTerrain(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof TerrainFeatureGrammarVisitor)
                return ((TerrainFeatureGrammarVisitor<? extends T>) visitor).visitTerrain(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class FileContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(TerrainFeatureGrammar.EOF, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).enterFile(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof TerrainFeatureGrammarListener)
                ((TerrainFeatureGrammarListener) listener).exitFile(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof TerrainFeatureGrammarVisitor)
                return ((TerrainFeatureGrammarVisitor<? extends T>) visitor).visitFile(this);
            else return visitor.visitChildren(this);
        }
    }
