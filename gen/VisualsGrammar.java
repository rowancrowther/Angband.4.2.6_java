...
public class VisualsGrammar extends Parser {
	...
	@Override
	public String getGrammarFileName() { return "VisualsGrammar.g4"; }
	...
	public static class FlickerContext extends ParserRuleContext {
		...
		public Token STRING;
		public TerminalNode FLICKER() { return getToken(VisualsGrammar.FLICKER, 0); }
		public TerminalNode COLOUR_CHAR() { return getToken(VisualsGrammar.COLOUR_CHAR, 0); }
		public TerminalNode SWAP_COLON() { return getToken(VisualsGrammar.SWAP_COLON, 0); }
		public TerminalNode STRING() { return getToken(VisualsGrammar.STRING, 0); }
		public FlickerContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_flicker; }
		@Override
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof VisualsGrammarVisitor ) return ((VisualsGrammarVisitor<? extends T>)visitor).visitFlicker(this);
	...
	public static class FlickerColourContext extends ParserRuleContext {
		public String colourChar;
		public Token COLOUR_CHAR;
		public TerminalNode FLICKER_COLOUR() { return getToken(VisualsGrammar.FLICKER_COLOUR, 0); }
		public TerminalNode COLOUR_CHAR() { return getToken(VisualsGrammar.COLOUR_CHAR, 0); }
		public FlickerColourContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_flickerColour; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof VisualsGrammarListener ) ((VisualsGrammarListener)listener).enterFlickerColour(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof VisualsGrammarVisitor ) return ((VisualsGrammarVisitor<? extends T>)visitor).visitFlickerColour(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class FlickerBlockContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_flickerBlock; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof VisualsGrammarVisitor ) return ((VisualsGrammarVisitor<? extends T>)visitor).visitFlickerBlock(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final FlickerBlockContext flickerBlock() throws RecognitionException {
		...
		try {
			...
			((FlickerBlockContext)_localctx).flicker = flicker();
			 name = ((FlickerBlockContext)_localctx).flicker.blockName; colourChar = ((FlickerBlockContext)_localctx).flicker.colourChar; 
			setState(29); 
	...
	public static class CycleContext extends ParserRuleContext {
		...
		public Token STRING;
		public TerminalNode CYCLE() { return getToken(VisualsGrammar.CYCLE, 0); }
		public TerminalNode STRING_BETWEEN_COLON() { return getToken(VisualsGrammar.STRING_BETWEEN_COLON, 0); }
		public TerminalNode DELIM_COLON() { return getToken(VisualsGrammar.DELIM_COLON, 0); }
		public TerminalNode STRING() { return getToken(VisualsGrammar.STRING, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof VisualsGrammarVisitor ) return ((VisualsGrammarVisitor<? extends T>)visitor).visitCycle(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class CycleColourContext extends ParserRuleContext {
		...
		public Token COLOUR_CHAR;
		public TerminalNode CYCLE_COLOUR() { return getToken(VisualsGrammar.CYCLE_COLOUR, 0); }
		public TerminalNode COLOUR_CHAR() { return getToken(VisualsGrammar.COLOUR_CHAR, 0); }
		public CycleColourContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_cycleColour; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof VisualsGrammarVisitor ) return ((VisualsGrammarVisitor<? extends T>)visitor).visitCycleColour(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class CycleBlockContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_cycleBlock; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof VisualsGrammarVisitor ) return ((VisualsGrammarVisitor<? extends T>)visitor).visitCycleBlock(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class FileContext extends ParserRuleContext {
		...
		public TerminalNode EOF() { return getToken(VisualsGrammar.EOF, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof VisualsGrammarVisitor ) return ((VisualsGrammarVisitor<? extends T>)visitor).visitFile(this);
			else return visitor.visitChildren(this);
		}
	}
