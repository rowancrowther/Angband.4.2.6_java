 ...
 * {@link uk.co.jackoftradesltd.middle.game.GameWorld}, mirroring C's split between {@code game-world.c}
 * (the clock) and {@code mon-move.c} (the monsters). Static methods over {@link uk.co.jackoftradesltd.middle.game.gameengine.GameState},
