...
// Generated from C:/Users/rowan/Documents/IntelliJProjects/Angband.4.2.6/src/main/java/uk/co/jackoftradesltd/backend/parser/grammars/SummonGrammar.g4 by ANTLR 4.13.2
package uk.co.jackoftradesltd.backend.parser.grammars.summon;
...
public class SummonGrammar extends Parser {
    ...
    public static class RecordCountContext extends ParserRuleContext {
        ...
        public TerminalNode RECORD_COUNT() {
            return getToken(SummonGrammar.RECORD_COUNT, 0);
        }

        public TerminalNode INTEGER() {
            return getToken(SummonGrammar.INTEGER, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SummonGrammarVisitor)
                return ((SummonGrammarVisitor<? extends T>) visitor).visitRecordCount(this);
    ...
    public static class NameContext extends ParserRuleContext {
        ...
        public TerminalNode NAME() {
            return getToken(SummonGrammar.NAME, 0);
        }

        public TerminalNode STRING() {
            return getToken(SummonGrammar.STRING, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SummonGrammarVisitor)
                return ((SummonGrammarVisitor<? extends T>) visitor).visitName(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class MsgtContext extends ParserRuleContext {
        ...
        public TerminalNode MSGT() {
            return getToken(SummonGrammar.MSGT, 0);
        }

        public TerminalNode FLAG() {
            return getToken(SummonGrammar.FLAG, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SummonGrammarVisitor)
                return ((SummonGrammarVisitor<? extends T>) visitor).visitMsgt(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class UniquesContext extends ParserRuleContext {
        ...
        public TerminalNode UNIQUES() {
            return getToken(SummonGrammar.UNIQUES, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SummonGrammarVisitor)
                return ((SummonGrammarVisitor<? extends T>) visitor).visitUniques(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class BaseContext extends ParserRuleContext {
        ...
        public List<TerminalNode> BASE() {
            return getTokens(SummonGrammar.BASE);
        }
        ...
        public List<TerminalNode> STRING() {
            return getTokens(SummonGrammar.STRING);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SummonGrammarVisitor)
                return ((SummonGrammarVisitor<? extends T>) visitor).visitBase(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class RaceFlagContext extends ParserRuleContext {
        ...
        public TerminalNode RACE_FLAG() {
            return getToken(SummonGrammar.RACE_FLAG, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SummonGrammarVisitor)
                return ((SummonGrammarVisitor<? extends T>) visitor).visitRaceFlag(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class FallbackContext extends ParserRuleContext {
        ...
        public TerminalNode FALLBACK() {
            return getToken(SummonGrammar.FALLBACK, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SummonGrammarVisitor)
                return ((SummonGrammarVisitor<? extends T>) visitor).visitFallback(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class DescContext extends ParserRuleContext {
        ...
        public TerminalNode DESC() {
            return getToken(SummonGrammar.DESC, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SummonGrammarVisitor)
                return ((SummonGrammarVisitor<? extends T>) visitor).visitDesc(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class SummonContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SummonGrammarVisitor)
                return ((SummonGrammarVisitor<? extends T>) visitor).visitSummon(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class FileContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(SummonGrammar.EOF, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SummonGrammarVisitor)
                return ((SummonGrammarVisitor<? extends T>) visitor).visitFile(this);
            else return visitor.visitChildren(this);
        }
    }
