...
import uk.co.jackoftrades.backend.parser.playerproperty.PlayerPropertyLexer;
import uk.co.jackoftrades.backend.parser.playerproperty.PlayerPropertyParser;
...
/**
 * Loads the relevant data-file entries into {@link PlayerProperty} objects by driving the
 ...
 * @author ClaudeCode
 */
public class PlayerPropertyReader implements Parser<PlayerProperty> {
    /**
    ...
    public List<PlayerProperty> parse(@NotNull String filename) throws IOException {
        try {
            ...
            PlayerPropertyParser.FileContext output = parser.file();
