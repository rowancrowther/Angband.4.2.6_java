...
/**
 * Builds a greater vault of the newer style — the port of C's {@code build_greater_new_vault}.
 *
 * <p>Same size limit as {@link GreaterVault}, at most 44x66, but drawn from the newer set of
 * layouts in {@code vault.txt}. Ignores the rating.
 *
 * <p><b>Stub:</b> not yet implemented; returns {@code false}.
 *
 * @author Rowan Crowther
 */
public class NewGreaterVault implements RoomBuilder {
    /**
     * {@inheritDoc}
     *
