...
public class SlayParser extends Parser {
    ...
    public static class CodeContext extends ParserRuleContext {
        ...
        public TerminalNode CODE() {
            return getToken(SlayParser.CODE, 0);
        }

        public TerminalNode FLAG() {
            return getToken(SlayParser.FLAG, 0);
        }
    ...
    public static class NameContext extends ParserRuleContext {
        ...
        public TerminalNode NAME() {
            return getToken(SlayParser.NAME, 0);
        }

        public TerminalNode TEXT() {
            return getToken(SlayParser.TEXT, 0);
        }
    ...
    public static class Race_flagContext extends ParserRuleContext {
        ...
        public TerminalNode RACE_FLAG() {
            return getToken(SlayParser.RACE_FLAG, 0);
        }
    ...
    public static class BaseContext extends ParserRuleContext {
        ...
        public TerminalNode BASE() {
            return getToken(SlayParser.BASE, 0);
        }

        public TerminalNode BASE_FLAG() {
            return getToken(SlayParser.BASE_FLAG, 0);
        }
    ...
    public static class MultiplierContext extends ParserRuleContext {
        ...
        public TerminalNode MULTIPLIER() {
            return getToken(SlayParser.MULTIPLIER, 0);
        }

        public TerminalNode NUMBER() {
            return getToken(SlayParser.NUMBER, 0);
        }
    ...
    public static class O_multiplierContext extends ParserRuleContext {
        ...
        public TerminalNode O_MULTIPLIER() {
            return getToken(SlayParser.O_MULTIPLIER, 0);
        }
    ...
    public static class PowerContext extends ParserRuleContext {
        ...
        public TerminalNode POWER() {
            return getToken(SlayParser.POWER, 0);
        }
    ...
    public static class Melee_verbContext extends ParserRuleContext {
        ...
        public TerminalNode MELEE_VERB() {
            return getToken(SlayParser.MELEE_VERB, 0);
        }
    ...
    public static class Ranged_verbContext extends ParserRuleContext {
        ...
        public TerminalNode RANGE_VERB() {
            return getToken(SlayParser.RANGE_VERB, 0);
        }
    ...
    public static class FileContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(SlayParser.EOF, 0);
        }
