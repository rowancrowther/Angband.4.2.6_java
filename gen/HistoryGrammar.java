...
public class HistoryGrammar extends Parser {
	...
	@Override
	public String getGrammarFileName() { return "HistoryGrammar.g4"; }
	...
	public static class RecordCountContext extends ParserRuleContext {
		...
		public TerminalNode RECORD_COUNT() { return getToken(HistoryGrammar.RECORD_COUNT, 0); }
		public TerminalNode INTEGER() { return getToken(HistoryGrammar.INTEGER, 0); }
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof HistoryGrammarVisitor ) return ((HistoryGrammarVisitor<? extends T>)visitor).visitRecordCount(this);
	...
	public static class ChartContext extends ParserRuleContext {
		...
		public Token nc;
		public Token p;
		public TerminalNode CHART() { return getToken(HistoryGrammar.CHART, 0); }
		public List<TerminalNode> COLON() { return getTokens(HistoryGrammar.COLON); }
		public TerminalNode COLON(int i) {
			return getToken(HistoryGrammar.COLON, i);
		}
		public List<TerminalNode> INTEGER() { return getTokens(HistoryGrammar.INTEGER); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof HistoryGrammarVisitor ) return ((HistoryGrammarVisitor<? extends T>)visitor).visitChart(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class PhraseContext extends ParserRuleContext {
		...
		public Token STRING;
		public TerminalNode PHRASE() { return getToken(HistoryGrammar.PHRASE, 0); }
		public TerminalNode STRING() { return getToken(HistoryGrammar.STRING, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof HistoryGrammarVisitor ) return ((HistoryGrammarVisitor<? extends T>)visitor).visitPhrase(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class RecordContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof HistoryGrammarVisitor ) return ((HistoryGrammarVisitor<? extends T>)visitor).visitRecord(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class FileContext extends ParserRuleContext {
		...
		public TerminalNode EOF() { return getToken(HistoryGrammar.EOF, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof HistoryGrammarVisitor ) return ((HistoryGrammarVisitor<? extends T>)visitor).visitFile(this);
			else return visitor.visitChildren(this);
		}
	}
