...
// Generated from C:/Users/rowan/Documents/IntelliJProjects/Angband.4.2.6/src/main/java/uk/co/jackoftradesltd/backend/parser/grammars/ObjectBaseGrammar.g4 by ANTLR 4.13.2
package uk.co.jackoftradesltd.backend.parser.grammars.objectbase;
...
public class ObjectBaseGrammar extends Parser {
    ...
    public static class RecordCountContext extends ParserRuleContext {
        ...
        public TerminalNode RECORD_COUNT() {
            return getToken(ObjectBaseGrammar.RECORD_COUNT, 0);
        }

        public TerminalNode INTEGER() {
            return getToken(ObjectBaseGrammar.INTEGER, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ObjectBaseGrammarListener)
                ((ObjectBaseGrammarListener) listener).enterRecordCount(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ObjectBaseGrammarListener)
                ((ObjectBaseGrammarListener) listener).exitRecordCount(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ObjectBaseGrammarVisitor)
                return ((ObjectBaseGrammarVisitor<? extends T>) visitor).visitRecordCount(this);
    ...
    public static class Default_valueContext extends ParserRuleContext {
        ...
        public TerminalNode DEFAULT_BREAK_CHANCE() {
            return getToken(ObjectBaseGrammar.DEFAULT_BREAK_CHANCE, 0);
        }
        ...
        public TerminalNode DEFAULT_MAX_STACK() {
            return getToken(ObjectBaseGrammar.DEFAULT_MAX_STACK, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ObjectBaseGrammarListener)
                ((ObjectBaseGrammarListener) listener).enterDefault_value(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ObjectBaseGrammarListener)
                ((ObjectBaseGrammarListener) listener).exitDefault_value(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ObjectBaseGrammarVisitor)
                return ((ObjectBaseGrammarVisitor<? extends T>) visitor).visitDefault_value(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class NameContext extends ParserRuleContext {
        ...
        public TerminalNode NAME() {
            return getToken(ObjectBaseGrammar.NAME, 0);
        }

        public TerminalNode T_VAL_COLON() {
            return getToken(ObjectBaseGrammar.T_VAL_COLON, 0);
        }

        public TerminalNode T_VAL() {
            return getToken(ObjectBaseGrammar.T_VAL, 0);
        }

        public TerminalNode STRING() {
            return getToken(ObjectBaseGrammar.STRING, 0);
        }

        public TerminalNode NAME_EOL() {
            return getToken(ObjectBaseGrammar.NAME_EOL, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ObjectBaseGrammarVisitor)
                return ((ObjectBaseGrammarVisitor<? extends T>) visitor).visitName(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class GraphicsContext extends ParserRuleContext {
        ...
        public TerminalNode GRAPHICS() {
            return getToken(ObjectBaseGrammar.GRAPHICS, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ObjectBaseGrammarListener)
                ((ObjectBaseGrammarListener) listener).enterGraphics(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ObjectBaseGrammarListener)
                ((ObjectBaseGrammarListener) listener).exitGraphics(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ObjectBaseGrammarVisitor)
                return ((ObjectBaseGrammarVisitor<? extends T>) visitor).visitGraphics(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Break_chanceContext extends ParserRuleContext {
        ...
        public TerminalNode BREAK() {
            return getToken(ObjectBaseGrammar.BREAK, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ObjectBaseGrammarListener)
                ((ObjectBaseGrammarListener) listener).enterBreak_chance(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ObjectBaseGrammarListener)
                ((ObjectBaseGrammarListener) listener).exitBreak_chance(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ObjectBaseGrammarVisitor)
                return ((ObjectBaseGrammarVisitor<? extends T>) visitor).visitBreak_chance(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Max_stackContext extends ParserRuleContext {
        ...
        public TerminalNode MAX_STACK() {
            return getToken(ObjectBaseGrammar.MAX_STACK, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ObjectBaseGrammarListener)
                ((ObjectBaseGrammarListener) listener).enterMax_stack(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ObjectBaseGrammarListener)
                ((ObjectBaseGrammarListener) listener).exitMax_stack(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ObjectBaseGrammarVisitor)
                return ((ObjectBaseGrammarVisitor<? extends T>) visitor).visitMax_stack(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class FlagsContext extends ParserRuleContext {
        ...
        public TerminalNode FLAGS() {
            return getToken(ObjectBaseGrammar.FLAGS, 0);
        }

        public TerminalNode FLAG_EOL() {
            return getToken(ObjectBaseGrammar.FLAG_EOL, 0);
        }

        public List<TerminalNode> FLAG() {
            return getTokens(ObjectBaseGrammar.FLAG);
        }
        ...
        public List<TerminalNode> FLAG_OR() {
            return getTokens(ObjectBaseGrammar.FLAG_OR);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ObjectBaseGrammarVisitor)
                return ((ObjectBaseGrammarVisitor<? extends T>) visitor).visitFlags(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Object_baseContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ObjectBaseGrammarListener)
                ((ObjectBaseGrammarListener) listener).enterObject_base(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ObjectBaseGrammarListener)
                ((ObjectBaseGrammarListener) listener).exitObject_base(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ObjectBaseGrammarVisitor)
                return ((ObjectBaseGrammarVisitor<? extends T>) visitor).visitObject_base(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class FileContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(ObjectBaseGrammar.EOF, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ObjectBaseGrammarVisitor)
                return ((ObjectBaseGrammarVisitor<? extends T>) visitor).visitFile(this);
            else return visitor.visitChildren(this);
        }
    }
