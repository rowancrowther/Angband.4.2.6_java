...
public class NameCreator {
     ...
     */
    public static String randnameMake(RandnameType nameType, int min, int max) {
        boolean foundWord = false;
        int lNum;
        StringBuilder buffer = new StringBuilder();

        int[][][] lProbs = buildProbs(E_WORD, S_WORD, TOTAL, nameType);
     ...
     */
    private static int[][][] buildProbs(int e_WORD, int s_WORD, int TOTAL, RandnameType nameType) {
