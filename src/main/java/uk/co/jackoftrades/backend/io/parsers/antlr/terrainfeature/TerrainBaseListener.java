...
/**
 * This class provides an empty implementation of {@link TerrainListener},
 * which can be extended to create a listener which only needs to handle a subset
 * of the available methods.
 */
@SuppressWarnings("CheckReturnValue")
public class TerrainBaseListener implements TerrainListener {
    /**
     * {@inheritDoc}
     *
     ...
     */
    @Override
    public void exitFeatures(TerrainParser.FeaturesContext ctx) {
    }
