...
public class BodyGrammar extends Parser {
	...
	@Override
	public String getGrammarFileName() { return "BodyGrammar.g4"; }
	...
	public static class RecordCountContext extends ParserRuleContext {
		...
		public TerminalNode RECORD_COUNT() { return getToken(BodyGrammar.RECORD_COUNT, 0); }
		public TerminalNode INTEGER() { return getToken(BodyGrammar.INTEGER, 0); }
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BodyGrammarVisitor ) return ((BodyGrammarVisitor<? extends T>)visitor).visitRecordCount(this);
	...
	public static class BodyContext extends ParserRuleContext {
		...
		public int line;
		public Token STRING;
		public TerminalNode BODY() { return getToken(BodyGrammar.BODY, 0); }
		public TerminalNode STRING() { return getToken(BodyGrammar.STRING, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BodyGrammarVisitor ) return ((BodyGrammarVisitor<? extends T>)visitor).visitBody(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class SlotContext extends ParserRuleContext {
		...
		public Token t;
		public Token n;
		public TerminalNode SLOT() { return getToken(BodyGrammar.SLOT, 0); }
		public TerminalNode COLON() { return getToken(BodyGrammar.COLON, 0); }
		public TerminalNode SLOT_NAME() { return getToken(BodyGrammar.SLOT_NAME, 0); }
		public TerminalNode STRING() { return getToken(BodyGrammar.STRING, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BodyGrammarVisitor ) return ((BodyGrammarVisitor<? extends T>)visitor).visitSlot(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class BodyTypeContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BodyGrammarVisitor ) return ((BodyGrammarVisitor<? extends T>)visitor).visitBodyType(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class FileContext extends ParserRuleContext {
		...
		public TerminalNode EOF() { return getToken(BodyGrammar.EOF, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BodyGrammarVisitor ) return ((BodyGrammarVisitor<? extends T>)visitor).visitFile(this);
			else return visitor.visitChildren(this);
		}
	}
