...
public class PlayerTimedLexer extends Lexer {
    ...
    private static String[] makeRuleNames() {
        return new String[]{
                "COMMENT", "EOL", "NAME", "DESC", "GRADE", "ON_END", "ON_INCREASE", "ON_DECREASE",
                "MSGT", "FAIL", "ON_BEGIN_EFFECT", "ON_END_EFFECT", "EFFECT_YX", "EFFECT_DICE",
                "EFFECT_EXPR", "EFFECT_MSG", "RESIST", "BRAND", "SLAY", "FLAG_SYNONYM",
                "LOWER_BOUND", "FLAGS", "INTEGER", "UCASE", "LCASE", "COLON", "STRING"
        };
    }
    ...
    public PlayerTimedLexer(CharStream input) {
        super(input);
