...
package uk.co.jackoftradesltd.backend.parser.grammars.realm;
...
import uk.co.jackoftradesltd.backend.parser.realm.RealmParseRecord;
...
public class RealmGrammar extends Parser {
    ...
    public static class RecordCountContext extends ParserRuleContext {
        ...
        public TerminalNode RECORD_COUNT() {
            return getToken(RealmGrammar.RECORD_COUNT, 0);
        }

        public TerminalNode INTEGER() {
            return getToken(RealmGrammar.INTEGER, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RealmGrammarVisitor)
                return ((RealmGrammarVisitor<? extends T>) visitor).visitRecordCount(this);
    ...
    public static class NameContext extends ParserRuleContext {
        ...
        public TerminalNode NAME() {
            return getToken(RealmGrammar.NAME, 0);
        }

        public TerminalNode STRING() {
            return getToken(RealmGrammar.STRING, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RealmGrammarVisitor)
                return ((RealmGrammarVisitor<? extends T>) visitor).visitName(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class StatContext extends ParserRuleContext {
        ...
        public TerminalNode STAT() {
            return getToken(RealmGrammar.STAT, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RealmGrammarVisitor)
                return ((RealmGrammarVisitor<? extends T>) visitor).visitStat(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class VerbContext extends ParserRuleContext {
        ...
        public TerminalNode VERB() {
            return getToken(RealmGrammar.VERB, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RealmGrammarVisitor)
                return ((RealmGrammarVisitor<? extends T>) visitor).visitVerb(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class SpellNounContext extends ParserRuleContext {
        ...
        public TerminalNode SPELL_NOUN() {
            return getToken(RealmGrammar.SPELL_NOUN, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RealmGrammarVisitor)
                return ((RealmGrammarVisitor<? extends T>) visitor).visitSpellNoun(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class BookNounContext extends ParserRuleContext {
        ...
        public TerminalNode BOOK_NOUN() {
            return getToken(RealmGrammar.BOOK_NOUN, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RealmGrammarVisitor)
                return ((RealmGrammarVisitor<? extends T>) visitor).visitBookNoun(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class RealmContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RealmGrammarVisitor)
                return ((RealmGrammarVisitor<? extends T>) visitor).visitRealm(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class FileContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(RealmGrammar.EOF, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RealmGrammarVisitor)
                return ((RealmGrammarVisitor<? extends T>) visitor).visitFile(this);
            else return visitor.visitChildren(this);
        }
    }
