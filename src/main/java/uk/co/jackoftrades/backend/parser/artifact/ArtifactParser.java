...
public class ArtifactParser extends Parser {
    ...
    public static class NameContext extends ParserRuleContext {
        ...
        public TerminalNode NAME() {
            return getToken(ArtifactParser.NAME, 0);
        }
    ...
    public static class BaseObjectContext extends ParserRuleContext {
        ...
        public TerminalNode BASE_OBJECT() {
            return getToken(ArtifactParser.BASE_OBJECT, 0);
        }

        public TerminalNode COLON() {
            return getToken(ArtifactParser.COLON, 0);
        }

        public TerminalNode MCASE() {
            return getToken(ArtifactParser.MCASE, 0);
        }
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ArtifactVisitor)
                return ((ArtifactVisitor<? extends T>) visitor).visitBaseObject(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class GraphicsContext extends ParserRuleContext {
        ...
        public TerminalNode GRAPHICS() {
            return getToken(ArtifactParser.GRAPHICS, 0);
        }
    ...
    public static class LevelContext extends ParserRuleContext {
        ...
        public TerminalNode LEVEL() {
            return getToken(ArtifactParser.LEVEL, 0);
        }

        public TerminalNode INTEGER() {
            return getToken(ArtifactParser.INTEGER, 0);
        }
    ...
    public static class WeightContext extends ParserRuleContext {
        ...
        public TerminalNode WEIGHT() {
            return getToken(ArtifactParser.WEIGHT, 0);
        }
    ...
    public static class CostContext extends ParserRuleContext {
        ...
        public TerminalNode COST() {
            return getToken(ArtifactParser.COST, 0);
        }
    ...
    public static class AllocContext extends ParserRuleContext {
        ...
        public TerminalNode ALLOC() {
            return getToken(ArtifactParser.ALLOC, 0);
        }
        ...
        public TerminalNode RANGE_TO() {
            return getToken(ArtifactParser.RANGE_TO, 0);
        }

        public List<TerminalNode> INTEGER() {
            return getTokens(ArtifactParser.INTEGER);
        }
    ...
    public static class AttackContext extends ParserRuleContext {
        ...
        public TerminalNode ATTACK() {
            return getToken(ArtifactParser.ATTACK, 0);
        }

        public TerminalNode DICE_STRING() {
            return getToken(ArtifactParser.DICE_STRING, 0);
        }

        public List<TerminalNode> COLON() {
            return getTokens(ArtifactParser.COLON);
        }
    ...
    public static class ArmourContext extends ParserRuleContext {
        ...
        public TerminalNode ARMOUR() {
            return getToken(ArtifactParser.ARMOUR, 0);
        }
    ...
    public static class FlagsContext extends ParserRuleContext {
        ...
        public TerminalNode FLAGS() {
            return getToken(ArtifactParser.FLAGS, 0);
        }

        public List<TerminalNode> MCASE() {
            return getTokens(ArtifactParser.MCASE);
        }
        ...
        public List<TerminalNode> OR() {
            return getTokens(ArtifactParser.OR);
        }
    ...
    public static class ValuesContext extends ParserRuleContext {
        ...
        public TerminalNode VALUES() {
            return getToken(ArtifactParser.VALUES, 0);
        }

        public List<TerminalNode> LBRACKET() {
            return getTokens(ArtifactParser.LBRACKET);
        }
        ...
        public List<TerminalNode> RBRACKET() {
            return getTokens(ArtifactParser.RBRACKET);
        }
    ...
    public static class ActContext extends ParserRuleContext {
        ...
        public TerminalNode ACT() {
            return getToken(ArtifactParser.ACT, 0);
        }
    ...
    public static class TimeContext extends ParserRuleContext {
        ...
        public TerminalNode TIME() {
            return getToken(ArtifactParser.TIME, 0);
        }
    ...
    public static class DescContext extends ParserRuleContext {
        ...
        public TerminalNode DESC() {
            return getToken(ArtifactParser.DESC, 0);
        }
    ...
    public static class BrandContext extends ParserRuleContext {
        ...
        public TerminalNode BRAND() {
            return getToken(ArtifactParser.BRAND, 0);
        }
    ...
    public static class SlayContext extends ParserRuleContext {
        ...
        public TerminalNode SLAY() {
            return getToken(ArtifactParser.SLAY, 0);
        }
    ...
    public static class CurseContext extends ParserRuleContext {
        ...
        public TerminalNode CURSE() {
            return getToken(ArtifactParser.CURSE, 0);
        }
    ...
    public static class MsgContext extends ParserRuleContext {
        ...
        public TerminalNode MSG() {
            return getToken(ArtifactParser.MSG, 0);
        }
    ...
    public static class FileContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(ArtifactParser.EOF, 0);
        }
