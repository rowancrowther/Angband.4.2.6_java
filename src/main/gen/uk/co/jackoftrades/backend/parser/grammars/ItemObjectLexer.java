...
public class ItemObjectLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"COMMENT", "EOL", "NAME", "GRAPHICS", "TYPE", "LEVEL", "WEIGHT", "COST", 
			"ATTACK", "ARMOUR", "ALLOC", "CHARGES", "PILE", "POWER", "MSG", "VIS_MSG", 
			"EFFECT", "EFFECT_YX", "DICE", "TIME", "EXPR", "FLAGS", "VALUES", "BRAND", 
			"SLAY", "CURSE", "PVAL", "DESC", "LONG_OR", "GRAPHICS_CHAR", "STRING"
		};
	}
	...
	public ItemObjectLexer(CharStream input) {
		super(input);
