...
/**
 * Builds a circular room — the port of C's {@code build_circular}.
 *
 * <p>Interior radius is 4 to 7 grids. Ignores the rating.
 *
 * <p><b>Stub:</b> not yet implemented; returns {@code false}.
 *
 * @author Rowan Crowther
 */
public class CircularRoom implements RoomBuilder {
    /**
     * {@inheritDoc}
     *
