 ...
 */
// Generated from ProjectionsLexer.g4 by ANTLR 4.13.2
...
public class ProjectionsLexer extends Lexer {
    static {
    ...
    public static final int
            FREE_TEXT = 1, DICE_MODE = 2;
    public static String[] channelNames = {
            "DEFAULT_TOKEN_CHANNEL", "HIDDEN"
    };

    public static String[] modeNames = {
            "DEFAULT_MODE", "FREE_TEXT", "DICE_MODE"
    };

    private static String[] makeRuleNames() {
        return new String[]{
                "RECORD_COUNT", "CODE", "NAME", "TYPE", "DESC", "PLAYER_DESC", "BLIND_DESC",
                "LASH_DESC", "NUMERATOR", "DENOMINATOR", "DIVISOR", "DAMAGE_CAP", "MSGT",
                "OBVIOUS", "WAKE", "COLOUR", "TAG", "INTEGER", "COMMENT", "EOL", "DICE_D",
    ...
    public ProjectionsLexer(CharStream input) {
        super(input);
