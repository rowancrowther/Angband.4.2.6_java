...
/**
 * This class provides an empty implementation of {@link TerrainVisitor},
...
public class TerrainBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements TerrainVisitor<T> {
	/**
	 * {@inheritDoc}
	 *
	 ...
	 */
	@Override
	public T visitFeatures(TerrainParser.FeaturesContext ctx) {
		return visitChildren(ctx);
	}
}