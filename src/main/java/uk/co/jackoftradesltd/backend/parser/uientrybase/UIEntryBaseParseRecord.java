...
package uk.co.jackoftradesltd.backend.parser.uientrybase;

import java.util.List;

/**
 * Immutable carrier for one raw {@code ui_entry_base.txt} template record, as
 * produced by {@link uk.co.jackoftradesltd.backend.parser.grammars.uientrybase.UIEntryBaseGrammar}'s
 ...
 * record into a {@link uk.co.jackoftradesltd.frontend.entries.UIEntryBase}. Keeping
