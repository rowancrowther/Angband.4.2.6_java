 ...
 * player's upkeep ({@link uk.co.jackoftradesltd.middle.player.PlayerUpkeep}); the render
...
public enum PlayerRedraw {
     ...
     * {@link uk.co.jackoftradesltd.middle.player.PlayerCalcs#redrawStuff(Player)} skips it in the loop and emits
