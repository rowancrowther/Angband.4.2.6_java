 ...
 */
// Generated from ProjectionGrammar.g4 by ANTLR 4.13.2
package uk.co.jackoftradesltd.backend.parser.grammars.projection;
...
public class ProjectionGrammar extends Parser {
    ...
    public static class RecordCountContext extends ParserRuleContext {
        ...
        public TerminalNode RECORD_COUNT() {
            return getToken(ProjectionGrammar.RECORD_COUNT, 0);
        }

        public TerminalNode INTEGER() {
            return getToken(ProjectionGrammar.INTEGER, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionGrammarListener)
                ((ProjectionGrammarListener) listener).enterRecordCount(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionGrammarListener)
                ((ProjectionGrammarListener) listener).exitRecordCount(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionGrammarVisitor)
                return ((ProjectionGrammarVisitor<? extends T>) visitor).visitRecordCount(this);
    ...
    public static class CodeContext extends ParserRuleContext {
        ...
        public TerminalNode CODE() {
            return getToken(ProjectionGrammar.CODE, 0);
        }

        public TerminalNode TAG() {
            return getToken(ProjectionGrammar.TAG, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionGrammarVisitor)
                return ((ProjectionGrammarVisitor<? extends T>) visitor).visitCode(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class NameContext extends ParserRuleContext {
        ...
        public TerminalNode NAME() {
            return getToken(ProjectionGrammar.NAME, 0);
        }

        public TerminalNode STRING() {
            return getToken(ProjectionGrammar.STRING, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionGrammarVisitor)
                return ((ProjectionGrammarVisitor<? extends T>) visitor).visitName(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class TypeContext extends ParserRuleContext {
        ...
        public TerminalNode TYPE() {
            return getToken(ProjectionGrammar.TYPE, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionGrammarVisitor)
                return ((ProjectionGrammarVisitor<? extends T>) visitor).visitType(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class DescContext extends ParserRuleContext {
        ...
        public TerminalNode DESC() {
            return getToken(ProjectionGrammar.DESC, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionGrammarVisitor)
                return ((ProjectionGrammarVisitor<? extends T>) visitor).visitDesc(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class PlayerDescContext extends ParserRuleContext {
        ...
        public TerminalNode PLAYER_DESC() {
            return getToken(ProjectionGrammar.PLAYER_DESC, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionGrammarListener)
                ((ProjectionGrammarListener) listener).enterPlayerDesc(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionGrammarListener)
                ((ProjectionGrammarListener) listener).exitPlayerDesc(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionGrammarVisitor)
                return ((ProjectionGrammarVisitor<? extends T>) visitor).visitPlayerDesc(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class BlindDescContext extends ParserRuleContext {
        ...
        public TerminalNode BLIND_DESC() {
            return getToken(ProjectionGrammar.BLIND_DESC, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionGrammarListener)
                ((ProjectionGrammarListener) listener).enterBlindDesc(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionGrammarListener)
                ((ProjectionGrammarListener) listener).exitBlindDesc(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionGrammarVisitor)
                return ((ProjectionGrammarVisitor<? extends T>) visitor).visitBlindDesc(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class LashDescContext extends ParserRuleContext {
        ...
        public TerminalNode LASH_DESC() {
            return getToken(ProjectionGrammar.LASH_DESC, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionGrammarListener)
                ((ProjectionGrammarListener) listener).enterLashDesc(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionGrammarListener)
                ((ProjectionGrammarListener) listener).exitLashDesc(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionGrammarVisitor)
                return ((ProjectionGrammarVisitor<? extends T>) visitor).visitLashDesc(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class NumeratorContext extends ParserRuleContext {
        ...
        public TerminalNode NUMERATOR() {
            return getToken(ProjectionGrammar.NUMERATOR, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionGrammarListener)
                ((ProjectionGrammarListener) listener).enterNumerator(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionGrammarListener)
                ((ProjectionGrammarListener) listener).exitNumerator(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionGrammarVisitor)
                return ((ProjectionGrammarVisitor<? extends T>) visitor).visitNumerator(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class DenominatorContext extends ParserRuleContext {
        ...
        public TerminalNode DENOMINATOR() {
            return getToken(ProjectionGrammar.DENOMINATOR, 0);
        }

        public TerminalNode SIMPLE_DICE() {
            return getToken(ProjectionGrammar.SIMPLE_DICE, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionGrammarListener)
                ((ProjectionGrammarListener) listener).enterDenominator(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionGrammarListener)
                ((ProjectionGrammarListener) listener).exitDenominator(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionGrammarVisitor)
                return ((ProjectionGrammarVisitor<? extends T>) visitor).visitDenominator(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class DivisorContext extends ParserRuleContext {
        ...
        public TerminalNode DIVISOR() {
            return getToken(ProjectionGrammar.DIVISOR, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionGrammarListener)
                ((ProjectionGrammarListener) listener).enterDivisor(this);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionGrammarVisitor)
                return ((ProjectionGrammarVisitor<? extends T>) visitor).visitDivisor(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class DamageCapContext extends ParserRuleContext {
        ...
        public TerminalNode DAMAGE_CAP() {
            return getToken(ProjectionGrammar.DAMAGE_CAP, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionGrammarListener)
                ((ProjectionGrammarListener) listener).enterDamageCap(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionGrammarListener)
                ((ProjectionGrammarListener) listener).exitDamageCap(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionGrammarVisitor)
                return ((ProjectionGrammarVisitor<? extends T>) visitor).visitDamageCap(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class MsgtContext extends ParserRuleContext {
        ...
        public TerminalNode MSGT() {
            return getToken(ProjectionGrammar.MSGT, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionGrammarVisitor)
                return ((ProjectionGrammarVisitor<? extends T>) visitor).visitMsgt(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ObviousContext extends ParserRuleContext {
        ...
        public TerminalNode OBVIOUS() {
            return getToken(ProjectionGrammar.OBVIOUS, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionGrammarListener)
                ((ProjectionGrammarListener) listener).enterObvious(this);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionGrammarVisitor)
                return ((ProjectionGrammarVisitor<? extends T>) visitor).visitObvious(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class WakeContext extends ParserRuleContext {
        ...
        public TerminalNode WAKE() {
            return getToken(ProjectionGrammar.WAKE, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionGrammarVisitor)
                return ((ProjectionGrammarVisitor<? extends T>) visitor).visitWake(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ColourContext extends ParserRuleContext {
        ...
        public TerminalNode COLOUR() {
            return getToken(ProjectionGrammar.COLOUR, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionGrammarVisitor)
                return ((ProjectionGrammarVisitor<? extends T>) visitor).visitColour(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ProjectionContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionGrammarListener)
                ((ProjectionGrammarListener) listener).enterProjection(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ProjectionGrammarListener)
                ((ProjectionGrammarListener) listener).exitProjection(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionGrammarVisitor)
                return ((ProjectionGrammarVisitor<? extends T>) visitor).visitProjection(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class FileContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(ProjectionGrammar.EOF, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProjectionGrammarVisitor)
                return ((ProjectionGrammarVisitor<? extends T>) visitor).visitFile(this);
            else return visitor.visitChildren(this);
        }
    }
