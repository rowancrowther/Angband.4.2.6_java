...
import uk.co.jackoftradesltd.backend.parser.activation.ActivationAssembler;
...
public class ActivationReader implements Reader<Activation> {
    ...
    /**
     * Parses {@code filename} and returns just the assembled activations, discarding the
     * soft-error channel (use {@link #parseWithResult} to inspect errors).
     *
     * <p>Function parse coded before 260915, commented in full on 260915.
     *
     * @param filename the data file to read
     * @return the activations read from the file
