...
public class VisualsParser extends Parser {
	...
	public static class FlickerContext extends ParserRuleContext {
		public TerminalNode FLICKER() { return getToken(VisualsParser.FLICKER, 0); }
		public TerminalNode COLOUR_CHAR() { return getToken(VisualsParser.COLOUR_CHAR, 0); }
		public TerminalNode COLON() { return getToken(VisualsParser.COLON, 0); }
		public TerminalNode LCASE() { return getToken(VisualsParser.LCASE, 0); }
	...
	public static class FlickerColourContext extends ParserRuleContext {
		public TerminalNode FLICKER_COLOUR() { return getToken(VisualsParser.FLICKER_COLOUR, 0); }
		public TerminalNode COLOUR_CHAR() { return getToken(VisualsParser.COLOUR_CHAR, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof VisualsVisitor ) return ((VisualsVisitor<? extends T>)visitor).visitFlickerColour(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class FlickerBlockContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof VisualsVisitor ) return ((VisualsVisitor<? extends T>)visitor).visitFlickerBlock(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class CycleContext extends ParserRuleContext {
		...
		public TerminalNode CYCLE() { return getToken(VisualsParser.CYCLE, 0); }
		public TerminalNode FLICKER() { return getToken(VisualsParser.FLICKER, 0); }
		public TerminalNode FANCY() { return getToken(VisualsParser.FANCY, 0); }
		public TerminalNode LCASE() { return getToken(VisualsParser.LCASE, 0); }
		public TerminalNode COLOUR_CHAR() { return getToken(VisualsParser.COLOUR_CHAR, 0); }
	...
	public static class CycleColourContext extends ParserRuleContext {
		...
		public Token COLOUR_CHAR;
		public TerminalNode CYCLE_COLOUR() { return getToken(VisualsParser.CYCLE_COLOUR, 0); }
		public TerminalNode COLOUR_CHAR() { return getToken(VisualsParser.COLOUR_CHAR, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof VisualsVisitor ) return ((VisualsVisitor<? extends T>)visitor).visitCycleColour(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class CycleBlockContext extends ParserRuleContext {
		public String name;
		public VisualsColourCycle colourCycleObj;
	...
	public final CycleBlockContext cycleBlock() throws RecognitionException {
		...
		try {
			...
			_ctx.stop = _input.LT(-1);
			            ...
			            ((CycleBlockContext)_localctx).colourCycleObj =  new VisualsColourCycle(cycleName, ColourType.COLOUR_TYPE_DARK);

			            for (ColourType colType : colourTypes)
			                _localctx.colourCycleObj.addStep(colType);

			            ((CycleBlockContext)_localctx).name =  groupName;
	...
	public static class FileContext extends ParserRuleContext {
		...
		public TerminalNode EOF() { return getToken(VisualsParser.EOF, 0); }
		...
		try {
			...
			do {
				...
				((FileContext)_localctx).cycleBlock = cycleBlock();
				                ...
				                VisualsCycleGroup group = cyclerMap.computeIfAbsent(((FileContext)_localctx).cycleBlock.name, name -> {
				                    VisualsCycleGroup newGroup = new VisualsCycleGroup();
				                    newGroup.setGroupName(name);
				                    return newGroup;
				                });
				                group.addCycle(((FileContext)_localctx).cycleBlock.colourCycleObj);
			...
			_ctx.stop = _input.LT(-1);
			            ...
			            for (VisualsCycleGroup group : cyclerMap.values())
			                _localctx.cycler.addVisualsCycleGroup(group);
