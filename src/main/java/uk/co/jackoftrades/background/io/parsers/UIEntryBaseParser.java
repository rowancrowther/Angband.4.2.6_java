...
import uk.co.jackoftrades.background.io.parsers.antlr.uientrybase.UIEntryBaseLexer;
...
public class UIEntryBaseParser {
    ...
    public ArrayList<UIEntryBase> parse(String filename) throws IOException {
        ...
        uk.co.jackoftrades.background.io.parsers.antlr.uientrybase.UIEntryBaseParser parser = new uk.co.jackoftrades.background.io.parsers.antlr.uientrybase.UIEntryBaseParser(tokens);
        uk.co.jackoftrades.background.io.parsers.antlr.uientrybase.UIEntryBaseParser.BasesContext bases = parser.bases();
